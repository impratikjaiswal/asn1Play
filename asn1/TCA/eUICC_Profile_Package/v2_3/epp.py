...
class PEDefinitions:
    ...
    _PE_DF_5GS_ef_nsi = SEQ_OF(name='ef-nsi', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    ...
    __FileManagement__item__filePath._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=2, ub=8)], ev=None, er=[])
    ...
    __PE_PINCodes_pinCodes_filePath._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=2, ub=8)], ev=None, er=[])
