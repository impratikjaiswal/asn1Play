...
class PEDefinitions:
    ...
    _PE_CDMAParameter_hrpdAccessAuthenticationData._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=9, ub=32)], ev=None, er=[])
    ...
    _PE_CDMAParameter_simpleIPAuthenticationData._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=10, ub=483)], ev=None, er=[])
    ...
    _PE_CDMAParameter_mobileIPAuthenticationData._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=19, ub=957)], ev=None, er=[])
