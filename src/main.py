...
def process_data(option):
    ...
    if option == options.parse_profile_element_data_pool_console_output:
        ...
        data_pool = [
            ...
            Data(raw_data=r'..\SampleData\PROFILE_OPERATIONAL1.hex', asn1_element=asn1_element,
    ...
    if option == options.parse_update_meta_data_pool_console_output:
        ...
        data_pool = [
            ...
            profilePolicyRules {ppr2}
             ...
             input_format=Formats.ASN1, output_format=Formats.DER, asn1_element=asn1_element
             ),
            #
            Data(raw_data='bf2a0499020520', asn1_element=asn1_element),
            #
            Data(raw_data=r'..\SampleData\UpdateMetadataRequest.asn1', asn1_element=asn1_element),
            #
            Data(raw_data=r'..\SampleData\UpdateMetadataRequest_ppr.asn1', asn1_element=asn1_element),
            #
            Data(raw_data=r'..\SampleData\UpdateMetadataRequest.hex', asn1_element=asn1_element),
        ]
        for data in data_pool:
            if isinstance(data, Data):
                parse_or_update_any_data(data.raw_data, print_inp=print_ip, print_info=print_info, re_parse_op=parse_op,
