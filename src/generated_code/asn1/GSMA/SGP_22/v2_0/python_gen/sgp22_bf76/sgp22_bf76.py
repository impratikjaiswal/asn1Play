...
class RSPDefinitions:
    ...
    _EUICCInfo2_uiccCapability = BIT_STR(name='uiccCapability', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'UICCCapability')))
    _EUICCInfo2_javacardVersion = OCT_STR(name='javacardVersion', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VersionType')), opt=True)
    ...
    EUICCInfo2._cont = ASN1Dict([
        ...
        ('javacardVersion', _EUICCInfo2_javacardVersion),
    ...
    RspCapability._cont = ASN1Dict([('additionalProfile', 0), ('crlSupport', 1), ('rpmSupport', 2), ('testProfileSupport', 3)])
    ...
    _DeviceCapabilities_eutranSupportedRelease = OCT_STR(name='eutranSupportedRelease', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VersionType')), opt=True)
    ...
    _DeviceCapabilities_rspRpmSupportedVersion = OCT_STR(name='rspRpmSupportedVersion', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VersionType')), opt=True)
    DeviceCapabilities._cont = ASN1Dict([
        ...
        ('rspRpmSupportedVersion', _DeviceCapabilities_rspRpmSupportedVersion),
        ])
    ...
    _ProfileInfo_profileClass = INT(name='profileClass', mode=MODE_TYPE, tag=(21, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'ProfileClass')), default=2)
    ...
    PprIds._cont = ASN1Dict([('pprUpdateControl', 0), ('ppr1', 1), ('ppr2', 2), ('ppr3', 3)])
    ...
    _StoreMetadataRequest_profileClass = INT(name='profileClass', mode=MODE_TYPE, tag=(21, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'ProfileClass')), opt=True)
    ...
    CancelSessionReason._cont = ASN1Dict([('endUserRejection', 0), ('postponed', 1), ('timeout', 2), ('pprNotAllowed', 3)])
    ...
    _ProfileInstallationResultData_smdpOid = OID(name='smdpOid', mode=MODE_TYPE, opt=True)
    ...
    _RetrieveNotificationsListResponse_notificationsListResultError._cont = ASN1Dict([('noResultAvailable', 1), ('undefinedError', 127)])
    ...
    _EnableProfileResponse_enableResult._cont = ASN1Dict([('ok', 0), ('iccidOrAidNotFound', 1), ('profileNotInDisabledState', 2), ('disallowedByPolicy', 3), ('wrongProfileReenabling', 4), ('undefinedError', 127)])
    ...
    _DisableProfileResponse_disableResult._cont = ASN1Dict([('ok', 0), ('iccidOrAidNotFound', 1), ('profileNotInEnabledState', 2), ('disallowedByPolicy', 3), ('undefinedError', 127)])
    ...
    _EuiccMemoryResetResponse_resetResult._cont = ASN1Dict([('ok', 0), ('nothingToDelete', 1), ('undefinedError', 127)])
    ...
    __LoadCRLResponseOk_missingParts__item_ = SEQ(name='_item_', mode=MODE_TYPE)
    ___LoadCRLResponseOk_missingParts__item__number = INT(name='number', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ___LoadCRLResponseOk_missingParts__item__number._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=None)], ev=None, er=[])
    __LoadCRLResponseOk_missingParts__item_._cont = ASN1Dict([
        ('number', ___LoadCRLResponseOk_missingParts__item__number),
        ])
    __LoadCRLResponseOk_missingParts__item_._ext = []
    ...
    LoadCRLResponseError._cont = ASN1Dict([('invalidSignature', 1), ('invalidCRLFormat', 2), ('notEnoughMemorySpace', 3), ('verificationKeyNotFound', 4), ('undefinedError', 127)])
    ...
    _AuthenticateClientOk_prepareDownloadRequest = SEQ(name='prepareDownloadRequest', mode=MODE_TYPE, tag=(33, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'PrepareDownloadRequest')))
    AuthenticateClientOk._cont = ASN1Dict([
        ...
        ('prepareDownloadRequest', _AuthenticateClientOk_prepareDownloadRequest),
        ])
    ...
    _GetBoundProfilePackageResponse_getBoundProfilePackageError._cont = ASN1Dict([('euiccSignatureInvalid', 1), ('confirmationCodeMissing', 2), ('confirmationCodeRefused', 3), ('confirmationCodeRetriesExceeded', 4), ('invalidTransactionId', 95), ('undefinedError', 127)])
    ...
    _all_ = [
        ...
        _DeviceCapabilities_rspRpmSupportedVersion,
        DeviceCapabilities,
        ...
        LoadCRLResponse,
        ___LoadCRLResponseOk_missingParts__item__number,
        ...
        _AuthenticateClientOk_prepareDownloadRequest,
        AuthenticateClientOk,
