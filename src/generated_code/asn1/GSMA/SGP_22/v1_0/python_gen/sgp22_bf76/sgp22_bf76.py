...
class RSPDefinitions:
    ...
    #-----< EIDPrefix >-----#
    EIDPrefix = OCT_STR(name='EIDPrefix', mode=MODE_TYPE)
    EIDPrefix._const_sz = ASN1Set(rv=[9], rr=[], ev=None, er=[])
    ...
    _EUICCInfo1_eUICCVerSupport = OCT_STR(name='eUICCVerSupport', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VersionType')))
    _EUICCInfo1_certificateInfo = BIT_STR(name='certificateInfo', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CertificateInfo')))
    _EUICCInfo1_curveSigningSupport = OCT_STR(name='curveSigningSupport', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CurveSigningSupport')))
    _EUICCInfo1_curveVerificationSupport = OCT_STR(name='curveVerificationSupport', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CurveVerificationSupport')))
    EUICCInfo1._cont = ASN1Dict([
        ('eUICCVerSupport', _EUICCInfo1_eUICCVerSupport),
        ('certificateInfo', _EUICCInfo1_certificateInfo),
        ('curveSigningSupport', _EUICCInfo1_curveSigningSupport),
        ('curveVerificationSupport', _EUICCInfo1_curveVerificationSupport),
        ])
    EUICCInfo1._ext = []
    
    #-----< EUICCInfo2 >-----#
    EUICCInfo2 = SEQ(name='EUICCInfo2', mode=MODE_TYPE)
    _EUICCInfo2_eIDPrefix = OCT_STR(name='eIDPrefix', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'EIDPrefix')))
    ...
    _EUICCInfo2_eUICCVerSupport = OCT_STR(name='eUICCVerSupport', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VersionType')))
    ...
    _EUICCInfo2_certificateInfo = BIT_STR(name='certificateInfo', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CertificateInfo')))
    _EUICCInfo2_curveSigningSupport = OCT_STR(name='curveSigningSupport', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CurveSigningSupport')))
    _EUICCInfo2_curveVerificationSupport = OCT_STR(name='curveVerificationSupport', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CurveVerificationSupport')))
    _EUICCInfo2_eUICCCapability = BIT_STR(name='eUICCCapability', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'EUICCCapability')))
    EUICCInfo2._cont = ASN1Dict([
        ('eIDPrefix', _EUICCInfo2_eIDPrefix),
        ('profileVersion', _EUICCInfo2_profileVersion),
        ('eUICCVerSupport', _EUICCInfo2_eUICCVerSupport),
        ('eUICCFirmwareVer', _EUICCInfo2_eUICCFirmwareVer),
        ('extCardResource', _EUICCInfo2_extCardResource),
        ('certificateInfo', _EUICCInfo2_certificateInfo),
        ('curveSigningSupport', _EUICCInfo2_curveSigningSupport),
        ('curveVerificationSupport', _EUICCInfo2_curveVerificationSupport),
        ('eUICCCapability', _EUICCInfo2_eUICCCapability),
        ])
    EUICCInfo2._ext = []
    
    #-----< CertificateInfo >-----#
    CertificateInfo = BIT_STR(name='CertificateInfo', mode=MODE_TYPE)
    CertificateInfo._cont = ASN1Dict([('certSigningGP', 0), ('certSigningX509', 1), ('rfu2', 2), ('rfu3', 3), ('certVerificationGP', 4), ('certVerificationX509', 5)])
    
    #-----< CurveSigningSupport >-----#
    CurveSigningSupport = OCT_STR(name='CurveSigningSupport', mode=MODE_TYPE)
    
    #-----< CurveVerificationSupport >-----#
    CurveVerificationSupport = OCT_STR(name='CurveVerificationSupport', mode=MODE_TYPE)
    
    #-----< EUICCCapability >-----#
    EUICCCapability = BIT_STR(name='EUICCCapability', mode=MODE_TYPE)
    EUICCCapability._cont = ASN1Dict([('contactlessSupport', 0), ('usimSupport', 1), ('isimSupport', 2), ('csimSupport', 3), ('akaMilenage', 4), ('akaTUAK', 5), ('akaCAVE', 6), ('gbaAuthenUSIM', 7), ('gbaAuthenISIM', 8), ('mbmsAuthenUSIM', 9), ('eapClient', 10), ('javacard', 11), ('multos', 12)])
    
    #-----< DeviceInfo >-----#
    DeviceInfo = SEQ(name='DeviceInfo', mode=MODE_TYPE)
    _DeviceInfo_tac = OCT_STR(name='tac', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet8')))
    ...
    _DeviceCapabilities_gsmSupportedRelease = OCT_STR(name='gsmSupportedRelease', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    _DeviceCapabilities_utranSupportedRelease = OCT_STR(name='utranSupportedRelease', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    _DeviceCapabilities_cdma2000onexSupportedRelease = OCT_STR(name='cdma2000onexSupportedRelease', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    _DeviceCapabilities_cdma2000hrpdSupportedRelease = OCT_STR(name='cdma2000hrpdSupportedRelease', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    _DeviceCapabilities_cdma2000ehrpdSupportedRelease = OCT_STR(name='cdma2000ehrpdSupportedRelease', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    _DeviceCapabilities_eutranSupportedRelease = OCT_STR(name='eutranSupportedRelease', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    _DeviceCapabilities_contactlessSupportedRelease = OCT_STR(name='contactlessSupportedRelease', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    DeviceCapabilities._cont = ASN1Dict([
        ...
        ('eutranSupportedRelease', _DeviceCapabilities_eutranSupportedRelease),
    ...
    _ProfileInfo_iccid = OCT_STR(name='iccid', mode=MODE_TYPE, tag=(26, TAG_APPLICATION, TAG_IMPLICIT), opt=True)
    _ProfileInfo_iccid._const_sz = ASN1Set(rv=[10], rr=[], ev=None, er=[])
    ...
    #-----< StoreMetadata >-----#
    StoreMetadata = SEQ(name='StoreMetadata', mode=MODE_TYPE, tag=(37, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _StoreMetadata_serviceProviderName = STR_UTF8(name='serviceProviderName', mode=MODE_TYPE, tag=(17, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _StoreMetadata_serviceProviderName._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=32)], ev=None, er=[])
    _StoreMetadata_profileName = STR_UTF8(name='profileName', mode=MODE_TYPE, tag=(18, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _StoreMetadata_profileName._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=64)], ev=None, er=[])
    _StoreMetadata_iconType = INT(name='iconType', mode=MODE_TYPE, tag=(19, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'IconType')), opt=True)
    _StoreMetadata_icon = OCT_STR(name='icon', mode=MODE_TYPE, tag=(20, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _StoreMetadata_icon._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=1024)], ev=None, er=[])
    _StoreMetadata_proprietaryTag = SEQ(name='proprietaryTag', mode=MODE_TYPE, tag=(118, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'ProprietaryTag')), opt=True)
    StoreMetadata._cont = ASN1Dict([
        ('serviceProviderName', _StoreMetadata_serviceProviderName),
        ('profileName', _StoreMetadata_profileName),
        ('iconType', _StoreMetadata_iconType),
        ('icon', _StoreMetadata_icon),
        ('proprietaryTag', _StoreMetadata_proprietaryTag),
        ])
    StoreMetadata._ext = []
    ...
    IconType._cont = ASN1Dict([('jgp', 0), ('png', 1)])
    ...
    _PrepareDownloadRequest_dpSigned1 = SEQ(name='dpSigned1', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'DPSigned1')))
    _PrepareDownloadRequest_smdpSignature1 = OCT_STR(name='smdpSignature1', mode=MODE_TYPE, tag=(55, TAG_APPLICATION, TAG_IMPLICIT))
    _PrepareDownloadRequest_activationCodeToken = STR_UTF8(name='activationCodeToken', mode=MODE_TYPE)
    _PrepareDownloadRequest_deviceInfo = SEQ(name='deviceInfo', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'DeviceInfo')))
    _PrepareDownloadRequest_smdpOID = OID(name='smdpOID', mode=MODE_TYPE, opt=True)
    _PrepareDownloadRequest_hashCC = OCT_STR(name='hashCC', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'Octet32')), opt=True)
    _PrepareDownloadRequest_certFormatTobeUsed = INT(name='certFormatTobeUsed', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'CertToBeUsed')))
    _PrepareDownloadRequest_curveTobeUsed = OCT_STR(name='curveTobeUsed', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'Octet1')))
    _PrepareDownloadRequest_smdpCertificate = CHOICE(name='smdpCertificate', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'RSPCertificate')))
    PrepareDownloadRequest._cont = ASN1Dict([
        ('dpSigned1', _PrepareDownloadRequest_dpSigned1),
        ('smdpSignature1', _PrepareDownloadRequest_smdpSignature1),
        ('activationCodeToken', _PrepareDownloadRequest_activationCodeToken),
        ('deviceInfo', _PrepareDownloadRequest_deviceInfo),
        ('smdpOID', _PrepareDownloadRequest_smdpOID),
        ('hashCC', _PrepareDownloadRequest_hashCC),
        ('certFormatTobeUsed', _PrepareDownloadRequest_certFormatTobeUsed),
        ('curveTobeUsed', _PrepareDownloadRequest_curveTobeUsed),
        ('smdpCertificate', _PrepareDownloadRequest_smdpCertificate),
        ])
    PrepareDownloadRequest._ext = []
    
    #-----< DPSigned1 >-----#
    DPSigned1 = SEQ(name='DPSigned1', mode=MODE_TYPE)
    _DPSigned1_euiccChallenge = OCT_STR(name='euiccChallenge', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet16')))
    _DPSigned1_smdpChallenge = OCT_STR(name='smdpChallenge', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet16')))
    _DPSigned1_transactionId = OCT_STR(name='transactionId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'OctetTo16')))
    _DPSigned1_smdpAdress = STR_UTF8(name='smdpAdress', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    DPSigned1._cont = ASN1Dict([
        ('euiccChallenge', _DPSigned1_euiccChallenge),
        ('smdpChallenge', _DPSigned1_smdpChallenge),
        ('transactionId', _DPSigned1_transactionId),
        ('smdpAdress', _DPSigned1_smdpAdress),
        ])
    DPSigned1._ext = []
    
    #-----< CertToBeUsed >-----#
    CertToBeUsed = INT(name='CertToBeUsed', mode=MODE_TYPE)
    CertToBeUsed._cont = ASN1Dict([('gp', 1), ('x509', 2)])
    
    #-----< PrepareDownloadResponse >-----#
    PrepareDownloadResponse = SEQ(name='PrepareDownloadResponse', mode=MODE_TYPE, tag=(34, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _PrepareDownloadResponse_euiccSigned1 = SEQ(name='euiccSigned1', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'EUICCSigned1')))
    _PrepareDownloadResponse_euiccSignature1 = OCT_STR(name='euiccSignature1', mode=MODE_TYPE, tag=(55, TAG_APPLICATION, TAG_IMPLICIT))
    _PrepareDownloadResponse_euiccCertificate = CHOICE(name='euiccCertificate', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'RSPCertificate')))
    _PrepareDownloadResponse_eumCertificate = CHOICE(name='eumCertificate', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'RSPCertificate')))
    PrepareDownloadResponse._cont = ASN1Dict([
        ('euiccSigned1', _PrepareDownloadResponse_euiccSigned1),
        ('euiccSignature1', _PrepareDownloadResponse_euiccSignature1),
        ('euiccCertificate', _PrepareDownloadResponse_euiccCertificate),
        ('eumCertificate', _PrepareDownloadResponse_eumCertificate),
        ])
    PrepareDownloadResponse._ext = []
    
    #-----< EUICCSigned1 >-----#
    EUICCSigned1 = SEQ(name='EUICCSigned1', mode=MODE_TYPE)
    _EUICCSigned1_smdpChallenge = OCT_STR(name='smdpChallenge', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet16')))
    _EUICCSigned1_transactionId = OCT_STR(name='transactionId', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'OctetTo16')))
    _EUICCSigned1_smdpAdress = STR_UTF8(name='smdpAdress', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EUICCSigned1_activationCodeToken = OCT_STR(name='activationCodeToken', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EUICCSigned1_deviceInfo = SEQ(name='deviceInfo', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'DeviceInfo')))
    _EUICCSigned1_smdpOID = OID(name='smdpOID', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _EUICCSigned1_hashCC = OCT_STR(name='hashCC', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet32')), opt=True)
    _EUICCSigned1_otpk = OCT_STR(name='otpk', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EUICCSigned1_euiccInfo2 = SEQ(name='euiccInfo2', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'EUICCInfo2')))
    EUICCSigned1._cont = ASN1Dict([
        ('smdpChallenge', _EUICCSigned1_smdpChallenge),
        ('transactionId', _EUICCSigned1_transactionId),
        ('smdpAdress', _EUICCSigned1_smdpAdress),
        ('activationCodeToken', _EUICCSigned1_activationCodeToken),
        ('deviceInfo', _EUICCSigned1_deviceInfo),
        ('smdpOID', _EUICCSigned1_smdpOID),
        ('hashCC', _EUICCSigned1_hashCC),
        ('otpk', _EUICCSigned1_otpk),
        ('euiccInfo2', _EUICCSigned1_euiccInfo2),
        ])
    EUICCSigned1._ext = []
    
    #-----< RSPCertificate >-----#
    RSPCertificate = CHOICE(name='RSPCertificate', mode=MODE_TYPE)
    _RSPCertificate_gp = OCT_STR(name='gp', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _RSPCertificate_x509 = SEQ(name='x509', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'Certificate')))
    RSPCertificate._cont = ASN1Dict([
        ('gp', _RSPCertificate_gp),
        ('x509', _RSPCertificate_x509),
        ])
    RSPCertificate._ext = []
    
    #-----< SetNicknameRequest >-----#
    SetNicknameRequest = SEQ(name='SetNicknameRequest', mode=MODE_TYPE, tag=(41, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _SetNicknameRequest_iccid = OCT_STR(name='iccid', mode=MODE_TYPE, tag=(26, TAG_APPLICATION, TAG_IMPLICIT))
    _SetNicknameRequest_iccid._const_sz = ASN1Set(rv=[10], rr=[], ev=None, er=[])
    ...
    _all_ = [
        ...
        Octet1,
        VersionType,
        _EUICCInfo1_eUICCVerSupport,
        _EUICCInfo1_certificateInfo,
        _EUICCInfo1_curveSigningSupport,
        _EUICCInfo1_curveVerificationSupport,
        EUICCInfo1,
        _EUICCInfo2_eIDPrefix,
        _EUICCInfo2_profileVersion,
        _EUICCInfo2_eUICCVerSupport,
        _EUICCInfo2_eUICCFirmwareVer,
        _EUICCInfo2_extCardResource,
        _EUICCInfo2_certificateInfo,
        _EUICCInfo2_curveSigningSupport,
        _EUICCInfo2_curveVerificationSupport,
        _EUICCInfo2_eUICCCapability,
        EUICCInfo2,
        CertificateInfo,
        CurveSigningSupport,
        CurveVerificationSupport,
        ...
        _DeviceCapabilities_eutranSupportedRelease,
        ...
        _ProfileInfo_icon,
        ProfileInfo,
        _StoreMetadata_serviceProviderName,
        _StoreMetadata_profileName,
        _StoreMetadata_iconType,
        _StoreMetadata_icon,
        _StoreMetadata_proprietaryTag,
        StoreMetadata,
        ...
        IconType,
        ProfileState,
        _PrepareDownloadRequest_dpSigned1,
        _PrepareDownloadRequest_smdpSignature1,
        _PrepareDownloadRequest_activationCodeToken,
        _PrepareDownloadRequest_deviceInfo,
        _PrepareDownloadRequest_smdpOID,
        _PrepareDownloadRequest_hashCC,
        _PrepareDownloadRequest_certFormatTobeUsed,
        _PrepareDownloadRequest_curveTobeUsed,
        _PrepareDownloadRequest_smdpCertificate,
        PrepareDownloadRequest,
        _DPSigned1_euiccChallenge,
        _DPSigned1_smdpChallenge,
        _DPSigned1_transactionId,
        _DPSigned1_smdpAdress,
        DPSigned1,
        CertToBeUsed,
        _PrepareDownloadResponse_euiccSigned1,
        _PrepareDownloadResponse_euiccSignature1,
        _PrepareDownloadResponse_euiccCertificate,
        _PrepareDownloadResponse_eumCertificate,
        PrepareDownloadResponse,
        _EUICCSigned1_smdpChallenge,
        _EUICCSigned1_transactionId,
        _EUICCSigned1_smdpAdress,
        _EUICCSigned1_activationCodeToken,
        _EUICCSigned1_deviceInfo,
        _EUICCSigned1_smdpOID,
        _EUICCSigned1_hashCC,
        _EUICCSigned1_otpk,
        _EUICCSigned1_euiccInfo2,
        EUICCSigned1,
        _RSPCertificate_gp,
        _RSPCertificate_x509,
        RSPCertificate,
...
init_modules(PKIX1Explicit88, PKIX1Implicit88, RSPDefinitions)
