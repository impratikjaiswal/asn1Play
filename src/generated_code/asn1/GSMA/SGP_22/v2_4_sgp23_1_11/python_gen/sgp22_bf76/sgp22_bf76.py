...
class RSPDefinitions:
    ...
    _EUICCInfo2_unknownEuiccInfo2Ext = INT(name='unknownEuiccInfo2Ext', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'EuiccInfo2Ext')), opt=True)
    EUICCInfo2._cont = ASN1Dict([
        ...
        ('unknownEuiccInfo2Ext', _EUICCInfo2_unknownEuiccInfo2Ext),
        ])
    EUICCInfo2._ext = []
    
    #-----< EuiccInfo2Ext >-----#
    EuiccInfo2Ext = INT(name='EuiccInfo2Ext', mode=MODE_TYPE, tag=(120, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    EuiccInfo2Ext._cont = ASN1Dict([('unknownServiceSupport1', 0), ('unknownServiceSupport2', 1)])
    ...
    _DeviceCapabilities_unknownServiceSupport = INT(name='unknownServiceSupport', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'DeviceCapExt')), opt=True)
    DeviceCapabilities._cont = ASN1Dict([
        ...
        ('unknownServiceSupport', _DeviceCapabilities_unknownServiceSupport),
        ])
    DeviceCapabilities._ext = []
    
    #-----< DeviceCapExt >-----#
    DeviceCapExt = INT(name='DeviceCapExt', mode=MODE_TYPE)
    DeviceCapExt._cont = ASN1Dict([('unknownServiceSupport1', 0), ('unknownServiceSupport2', 1)])
    ...
    _DpProprietaryData_additionalSmdpData = OCT_STR(name='additionalSmdpData', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    DpProprietaryData._cont = ASN1Dict([
        ('dpOid', _DpProprietaryData_dpOid),
        ('additionalSmdpData', _DpProprietaryData_additionalSmdpData),
        ])
    ...
    _all_ = [
        ...
        _EUICCInfo2_unknownEuiccInfo2Ext,
        EUICCInfo2,
        EuiccInfo2Ext,
        RspCapability,
        ...
        _DeviceCapabilities_unknownServiceSupport,
        DeviceCapabilities,
        DeviceCapExt,
        ...
        _DpProprietaryData_additionalSmdpData,
        DpProprietaryData,
