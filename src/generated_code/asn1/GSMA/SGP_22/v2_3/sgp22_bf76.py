...
class RSPDefinitions:
    ...
    RspCapability._cont = ASN1Dict([('additionalProfile', 0), ('crlSupport', 1), ('rpmSupport', 2), ('testProfileSupport', 3), ('deviceInfoExtensibilitySupport', 4)])
