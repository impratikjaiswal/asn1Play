...
class RSPDefinitions:
    ...
    _EUICCInfo1_curveVandKASupport = OCT_STR(name='curveVandKASupport', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CurveVandKASupport')))
    EUICCInfo1._cont = ASN1Dict([
        ...
        ('curveVandKASupport', _EUICCInfo1_curveVandKASupport),
        ])
    EUICCInfo1._ext = []
    ...
    _EUICCInfo2_curveVandKASupport = OCT_STR(name='curveVandKASupport', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'CurveVandKASupport')))
    ...
    EUICCInfo2._cont = ASN1Dict([
        ...
        ('curveVandKASupport', _EUICCInfo2_curveVandKASupport),
    ...
    #-----< StoreMetadataResponse >-----#
    StoreMetadataResponse = SEQ(name='StoreMetadataResponse', mode=MODE_TYPE, tag=(37, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _StoreMetadataResponse_errorCode = OCT_STR(name='errorCode', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet1')), opt=True)
    StoreMetadataResponse._cont = ASN1Dict([
        ('errorCode', _StoreMetadataResponse_errorCode),
        ])
    StoreMetadataResponse._ext = []
    ...
    _DPSigned1_smdpAddress = STR_UTF8(name='smdpAddress', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    DPSigned1._cont = ASN1Dict([
        ...
        ('smdpAddress', _DPSigned1_smdpAddress),
        ])
    DPSigned1._ext = []
    ...
    #-----< PrepareDownloadResponse >-----#
    PrepareDownloadResponse = SEQ(name='PrepareDownloadResponse', mode=MODE_TYPE, tag=(33, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ...
    _EUICCSigned1_smdpAddress = STR_UTF8(name='smdpAddress', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EUICCSigned1_activationCodeToken = STR_UTF8(name='activationCodeToken', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ...
    EUICCSigned1._cont = ASN1Dict([
        ...
        ('smdpAddress', _EUICCSigned1_smdpAddress),
    ...
    id_rsp._val = (2, 23, 146, 1, 1, 1)
    
    #-----< id-rspExt >-----#
    id_rspExt = OID(name='id-rspExt', mode=MODE_VALUE)
    id_rspExt._val = (2, 23, 146, 1, 1, 1, 0)
    
    #-----< id-rspRole >-----#
    id_rspRole = OID(name='id-rspRole', mode=MODE_VALUE)
    id_rspRole._val = (2, 23, 146, 1, 1, 1, 1)
    
    #-----< id-rsp-sasSn >-----#
    id_rsp_sasSn = OID(name='id-rsp-sasSn', mode=MODE_VALUE)
    id_rsp_sasSn._val = (2, 23, 146, 1, 1, 1, 0, 0)
    
    #-----< SasSn >-----#
    SasSn = STR_UTF8(name='SasSn', mode=MODE_TYPE)
    SasSn._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=64)], ev=None, er=[])
    
    #-----< id-rspRole-ci >-----#
    id_rspRole_ci = OID(name='id-rspRole-ci', mode=MODE_VALUE)
    id_rspRole_ci._val = (2, 23, 146, 1, 1, 1, 1, 0)
    
    #-----< id-rspRole-euicc >-----#
    id_rspRole_euicc = OID(name='id-rspRole-euicc', mode=MODE_VALUE)
    id_rspRole_euicc._val = (2, 23, 146, 1, 1, 1, 1, 1)
    
    #-----< id-rspRole-eum >-----#
    id_rspRole_eum = OID(name='id-rspRole-eum', mode=MODE_VALUE)
    id_rspRole_eum._val = (2, 23, 146, 1, 1, 1, 1, 2)
    
    #-----< id-rspRole-dp-pb >-----#
    id_rspRole_dp_pb = OID(name='id-rspRole-dp-pb', mode=MODE_VALUE)
    id_rspRole_dp_pb._val = (2, 23, 146, 1, 1, 1, 1, 4)
    ...
    _all_ = [
        ...
        _EUICCInfo1_curveVandKASupport,
        EUICCInfo1,
        ...
        _EUICCInfo2_curveVandKASupport,
        ...
        IconType,
        ProfileState,
        _StoreMetadataResponse_errorCode,
        StoreMetadataResponse,
