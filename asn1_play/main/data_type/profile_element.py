...
class ProfileElement(DataTypeMaster):
    ...
    def set_data_pool(self):
        data_pool = [
            #
            Folders.in_sample_epp(r'$VERSION\PROFILE_OPERATIONAL1.asn1'),
            #
            Folders.in_sample_epp(r'$VERSION\PROFILE_OPERATIONAL1.hex'),
            #
            ...
            Data(
                ...
                input_data=Folders.in_sample_epp(r'$VERSION\PROFILE_OPERATIONAL1.hex'),
