...
class StoreMetaData(DataTypeMaster):
    ...
    def set_data_pool(self):
        data_pool = [
            ...
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest.asn1'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_wo_icon.asn1'),
            #
            Folders.in_sample_sgp_22(
                fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_wo_icon_wo_serviceSpecific.asn1'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest.hex'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_wo_icon.hex'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest.base64'),
            #
            Folders.in_sample_sgp_22(
                fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_wo_icon.base64'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_output.asn1'),
            #
            Folders.in_sample_sgp_22(
                fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_wo_icon_output.asn1'),
            #
            Folders.in_sample_sgp_22(
                fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_Mandatory.asn1'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_ppr.asn1'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_Mandatory.hex'),
            #
            Folders.in_sample_sgp_22(fr'{PhVariables.VERSION}\StoreMetadataRequest\StoreMetadataRequest_ppr.hex'),
            #
        ]
