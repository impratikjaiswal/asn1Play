...
def print_data(data=None, meta_data=None, info_data=None, master_data=None):
    ...
    if data.print_info:
        ...
        mode = get_mode(data.input_format, data.output_format, meta_data.input_mode_key,
                        data.get_input_modes_hierarchy())
        info_contents_pool = {
            PhKeys.TRANSACTION_ID: meta_data.transaction_id,
            PhKeys.MODE: mode,
            PhKeys.ASN1_SCHEMA: asn1_info.get(PhKeys.ASN1_SCHEMA, None),
            PhKeys.ASN1_MODULE: asn1_info.get(PhKeys.ASN1_MODULE, None),
            PhKeys.ASN1_MODULE_VERSION: asn1_info.get(PhKeys.ASN1_MODULE_VERSION, None),
            PhKeys.ASN1_OBJECT: asn1_info.get(PhKeys.ASN1_OBJECT, None),
            PhKeys.ASN1_OBJECT_ALTERNATE: asn1_info.get(PhKeys.ASN1_OBJECT_ALTERNATE, None),
            PhKeys.FETCH_ASN1_OBJECTS_LIST: asn1_info.get(PhKeys.FETCH_ASN1_OBJECTS_LIST, None),
