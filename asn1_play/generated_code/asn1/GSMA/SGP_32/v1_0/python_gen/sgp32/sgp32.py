...
class SGP32Definitions:
    ...
    __EimConfigurationData_eimPublicKeyData_eimPublicKey = SEQ(name='eimPublicKey', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'SubjectPublicKeyInfo')))
    __EimConfigurationData_eimPublicKeyData_eimCertificate = SEQ(name='eimCertificate', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'Certificate')))
    ...
    _EimConfigurationData_trustedPublicKeyDataTls = CHOICE(name='trustedPublicKeyDataTls', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __EimConfigurationData_trustedPublicKeyDataTls_trustedEimPkTls = SEQ(name='trustedEimPkTls', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'SubjectPublicKeyInfo')))
    __EimConfigurationData_trustedPublicKeyDataTls_trustedCertificateTls = SEQ(name='trustedCertificateTls', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'Certificate')))
    ...
    _EimConfigurationData_eimSupportedProtocol = BIT_STR(name='eimSupportedProtocol', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EimSupportedProtocol')), opt=True)
    _EimConfigurationData_euiccCiPKId = OCT_STR(name='euiccCiPKId', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Implicit88', 'SubjectKeyIdentifier')), opt=True)
