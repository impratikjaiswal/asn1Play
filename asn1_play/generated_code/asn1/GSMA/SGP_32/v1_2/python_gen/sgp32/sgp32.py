...
class SGP32Definitions:
    ...
    _EuiccPackageSigned_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    ...
    _EuiccPackageSigned_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    ...
    EuiccPackageSigned._cont = ASN1Dict([
        ...
        ('eimTransactionId', _EuiccPackageSigned_eimTransactionId),
    ...
    _EimConfigurationData_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    ...
    _EimConfigurationData_indirectProfileDownload = NULL(name='indirectProfileDownload', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    EimConfigurationData._cont = ASN1Dict([
        ...
        ('indirectProfileDownload', _EimConfigurationData_indirectProfileDownload),
        ])
    ...
    _Psmo_getRAT._ext = []
    _Psmo_configureImmediateEnable = SEQ(name='configureImmediateEnable', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __Psmo_configureImmediateEnable_immediateEnableFlag = NULL(name='immediateEnableFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __Psmo_configureImmediateEnable_defaultSmdpOid = OID(name='defaultSmdpOid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __Psmo_configureImmediateEnable_defaultSmdpAddress = STR_UTF8(name='defaultSmdpAddress', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _Psmo_configureImmediateEnable._cont = ASN1Dict([
        ('immediateEnableFlag', __Psmo_configureImmediateEnable_immediateEnableFlag),
        ('defaultSmdpOid', __Psmo_configureImmediateEnable_defaultSmdpOid),
        ('defaultSmdpAddress', __Psmo_configureImmediateEnable_defaultSmdpAddress),
        ])
    _Psmo_configureImmediateEnable._ext = []
    _Psmo_setFallbackAttribute = SEQ(name='setFallbackAttribute', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __Psmo_setFallbackAttribute_iccid = OCT_STR(name='iccid', mode=MODE_TYPE, tag=(26, TAG_APPLICATION, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Iccid')))
    _Psmo_setFallbackAttribute._cont = ASN1Dict([
        ('iccid', __Psmo_setFallbackAttribute_iccid),
        ])
    _Psmo_setFallbackAttribute._ext = []
    _Psmo_unsetFallbackAttribute = SEQ(name='unsetFallbackAttribute', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Psmo_unsetFallbackAttribute._cont = ASN1Dict([
        ])
    _Psmo_unsetFallbackAttribute._ext = []
    _Psmo_setDefaultDpAddress = SEQ(name='setDefaultDpAddress', mode=MODE_TYPE, tag=(101, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'SetDefaultDpAddressRequest')))
    Psmo._cont = ASN1Dict([
        ('enable', _Psmo_enable),
        ...
        ('getRAT', _Psmo_getRAT),
        ('configureImmediateEnable', _Psmo_configureImmediateEnable),
        ('setFallbackAttribute', _Psmo_setFallbackAttribute),
        ('unsetFallbackAttribute', _Psmo_unsetFallbackAttribute),
        ('setDefaultDpAddress', _Psmo_setDefaultDpAddress),
        ])
    Psmo._ext = []
    ...
    _IpaEuiccDataRequest_euiccCiPKIdentifierToBeUsed = OCT_STR(name='euiccCiPKIdentifierToBeUsed', mode=MODE_TYPE, opt=True)
    _IpaEuiccDataRequest_searchCriteriaNotification = CHOICE(name='searchCriteriaNotification', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __IpaEuiccDataRequest_searchCriteriaNotification_seqNumber = INT(name='seqNumber', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __IpaEuiccDataRequest_searchCriteriaNotification_profileManagementOperation = BIT_STR(name='profileManagementOperation', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'NotificationEvent')))
    _IpaEuiccDataRequest_searchCriteriaNotification._cont = ASN1Dict([
        ('seqNumber', __IpaEuiccDataRequest_searchCriteriaNotification_seqNumber),
        ('profileManagementOperation', __IpaEuiccDataRequest_searchCriteriaNotification_profileManagementOperation),
        ])
    _IpaEuiccDataRequest_searchCriteriaNotification._ext = []
    _IpaEuiccDataRequest_searchCriteriaEuiccPackageResult = CHOICE(name='searchCriteriaEuiccPackageResult', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    __IpaEuiccDataRequest_searchCriteriaEuiccPackageResult_seqNumber = INT(name='seqNumber', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _IpaEuiccDataRequest_searchCriteriaEuiccPackageResult._cont = ASN1Dict([
        ('seqNumber', __IpaEuiccDataRequest_searchCriteriaEuiccPackageResult_seqNumber),
        ])
    _IpaEuiccDataRequest_searchCriteriaEuiccPackageResult._ext = []
    _IpaEuiccDataRequest_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    IpaEuiccDataRequest._cont = ASN1Dict([
        ('tagList', _IpaEuiccDataRequest_tagList),
        ('euiccCiPKIdentifierToBeUsed', _IpaEuiccDataRequest_euiccCiPKIdentifierToBeUsed),
        ('searchCriteriaNotification', _IpaEuiccDataRequest_searchCriteriaNotification),
        ('searchCriteriaEuiccPackageResult', _IpaEuiccDataRequest_searchCriteriaEuiccPackageResult),
        ('eimTransactionId', _IpaEuiccDataRequest_eimTransactionId),
        ])
    ...
    _EuiccPackageResultDataSigned_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    _EuiccPackageResultDataSigned_counterValue = INT(name='counterValue', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccPackageResultDataSigned_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    ...
    EuiccPackageResultDataSigned._cont = ASN1Dict([
        ...
        ('eimTransactionId', _EuiccPackageResultDataSigned_eimTransactionId),
    ...
    _EuiccResultData_configureImmediateEnableResult = INT(name='configureImmediateEnableResult', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ConfigureImmediateEnableResult')))
    ...
    _EuiccResultData_setFallbackAttributeResult = INT(name='setFallbackAttributeResult', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'SetFallbackAttributeResult')))
    _EuiccResultData_unsetFallbackAttributeResult = INT(name='unsetFallbackAttributeResult', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'UnsetFallbackAttributeResult')))
    ...
    _EuiccResultData_setDefaultDpAddressResult = SEQ(name='setDefaultDpAddressResult', mode=MODE_TYPE, tag=(101, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'SetDefaultDpAddressResponse')))
    EuiccResultData._cont = ASN1Dict([
        ...
        ('configureImmediateEnableResult', _EuiccResultData_configureImmediateEnableResult),
        ...
        ('setFallbackAttributeResult', _EuiccResultData_setFallbackAttributeResult),
        ('unsetFallbackAttributeResult', _EuiccResultData_unsetFallbackAttributeResult),
        ('processingTerminated', _EuiccResultData_processingTerminated),
        ('setDefaultDpAddressResult', _EuiccResultData_setDefaultDpAddressResult),
        ])
    ...
    _EuiccPackageErrorDataSigned_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    _EuiccPackageErrorDataSigned_counterValue = INT(name='counterValue', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccPackageErrorDataSigned_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    ...
    EuiccPackageErrorDataSigned._cont = ASN1Dict([
        ...
        ('eimTransactionId', _EuiccPackageErrorDataSigned_eimTransactionId),
    ...
    EuiccPackageErrorCode._cont = ASN1Dict([('invalidEid', 3), ('replayError', 4), ('counterValueOutOfRange', 6), ('sizeOverflow', 15), ('ecallActive', 104), ('undefinedError', 127)])
    ...
    _EuiccPackageErrorUnsigned_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    _EuiccPackageErrorUnsigned_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    ...
    EuiccPackageErrorUnsigned._cont = ASN1Dict([
        ...
        ('eimTransactionId', _EuiccPackageErrorUnsigned_eimTransactionId),
        ('associationToken', _EuiccPackageErrorUnsigned_associationToken),
        ])
    EuiccPackageErrorUnsigned._ext = []
    
    #-----< ConfigureImmediateEnableResult >-----#
    ConfigureImmediateEnableResult = INT(name='ConfigureImmediateEnableResult', mode=MODE_TYPE)
    ConfigureImmediateEnableResult._cont = ASN1Dict([('ok', 0), ('insufficientMemory', 1), ('commandError', 7), ('undefinedError', 127)])
    
    #-----< EnableProfileResult >-----#
    EnableProfileResult = INT(name='EnableProfileResult', mode=MODE_TYPE)
    EnableProfileResult._cont = ASN1Dict([('ok', 0), ('iccidOrAidNotFound', 1), ('profileNotInDisabledState', 2), ('disallowedByPolicy', 3), ('catBusy', 5), ('rollbackNotAvailable', 20), ('undefinedError', 127)])
    
    #-----< DisableProfileResult >-----#
    DisableProfileResult = INT(name='DisableProfileResult', mode=MODE_TYPE)
    DisableProfileResult._cont = ASN1Dict([('ok', 0), ('iccidOrAidNotFound', 1), ('profileNotInEnabledState', 2), ('disallowedByPolicy', 3), ('catBusy', 5), ('undefinedError', 127)])
    
    #-----< DeleteProfileResult >-----#
    DeleteProfileResult = INT(name='DeleteProfileResult', mode=MODE_TYPE)
    DeleteProfileResult._cont = ASN1Dict([('ok', 0), ('iccidOrAidNotFound', 1), ('profileNotInDisabledState', 2), ('disallowedByPolicy', 3), ('rollbackNotAvailable', 20), ('returnFallbackProfile', 21), ('undefinedError', 127)])
    
    #-----< ProfileInfoListResponse >-----#
    ProfileInfoListResponse = CHOICE(name='ProfileInfoListResponse', mode=MODE_TYPE, tag=(45, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ProfileInfoListResponse_profileInfoListOk = SEQ_OF(name='profileInfoListOk', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __ProfileInfoListResponse_profileInfoListOk__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'ProfileInfo')))
    _ProfileInfoListResponse_profileInfoListOk._cont = __ProfileInfoListResponse_profileInfoListOk__item_
    ...
    #-----< SetFallbackAttributeResult >-----#
    SetFallbackAttributeResult = INT(name='SetFallbackAttributeResult', mode=MODE_TYPE)
    SetFallbackAttributeResult._cont = ASN1Dict([('ok', 0), ('iccidOrAidNotFound', 1), ('fallbackNotAllowed', 2), ('fallbackProfileEnabled', 3), ('undefinedError', 127)])
    
    #-----< UnsetFallbackAttributeResult >-----#
    UnsetFallbackAttributeResult = INT(name='UnsetFallbackAttributeResult', mode=MODE_TYPE)
    UnsetFallbackAttributeResult._cont = ASN1Dict([('ok', 0), ('noFallbackAttribute', 2), ('fallbackProfileEnabled', 3), ('commandError', 7), ('undefinedError', 127)])
    ...
    _AddEimResult_addEimResultCode._cont = ASN1Dict([('ok', 0), ('insufficientMemory', 1), ('associatedEimAlreadyExists', 2), ('ciPKUnknown', 3), ('invalidAssociationToken', 5), ('counterValueOutOfRange', 6), ('commandError', 7), ('undefinedError', 127)])
    ...
    _ListEimResult_listEimError._cont = ASN1Dict([('undefinedError', 127)])
    ...
    _EimIdInfo_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    _EimIdInfo_eimIdType = INT(name='eimIdType', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EimIdType')), opt=True)
    ...
    #-----< IpaEuiccDataErrorCode >-----#
    IpaEuiccDataErrorCode = INT(name='IpaEuiccDataErrorCode', mode=MODE_TYPE)
    IpaEuiccDataErrorCode._cont = ASN1Dict([('incorrectTagList', 1), ('euiccCiPKIdNotFound', 5), ('ecallActive', 104), ('undefinedError', 127)])
    
    #-----< IpaEuiccDataResponseError >-----#
    IpaEuiccDataResponseError = SEQ(name='IpaEuiccDataResponseError', mode=MODE_TYPE)
    _IpaEuiccDataResponseError_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    _IpaEuiccDataResponseError_ipaEuiccDataErrorCode = INT(name='ipaEuiccDataErrorCode', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'IpaEuiccDataErrorCode')))
    IpaEuiccDataResponseError._cont = ASN1Dict([
        ('eimTransactionId', _IpaEuiccDataResponseError_eimTransactionId),
        ('ipaEuiccDataErrorCode', _IpaEuiccDataResponseError_ipaEuiccDataErrorCode),
        ])
    IpaEuiccDataResponseError._ext = []
    ...
    _IpaEuiccDataResponse_ipaEuiccDataResponseError = SEQ(name='ipaEuiccDataResponseError', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'IpaEuiccDataResponseError')))
    IpaEuiccDataResponse._cont = ASN1Dict([
        ('ipaEuiccData', _IpaEuiccDataResponse_ipaEuiccData),
        ('ipaEuiccDataResponseError', _IpaEuiccDataResponse_ipaEuiccDataResponseError),
        ])
    IpaEuiccDataResponse._ext = []
    
    #-----< PendingNotificationList >-----#
    PendingNotificationList = SEQ_OF(name='PendingNotificationList', mode=MODE_TYPE)
    _PendingNotificationList__item_ = CHOICE(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'PendingNotification')))
    PendingNotificationList._cont = _PendingNotificationList__item_
    
    #-----< EuiccPackageResultList >-----#
    EuiccPackageResultList = SEQ_OF(name='EuiccPackageResultList', mode=MODE_TYPE)
    _EuiccPackageResultList__item_ = CHOICE(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'EuiccPackageResult')))
    EuiccPackageResultList._cont = _EuiccPackageResultList__item_
    
    #-----< IpaEuiccData >-----#
    IpaEuiccData = SEQ(name='IpaEuiccData', mode=MODE_TYPE)
    _IpaEuiccData_notificationsList = SEQ_OF(name='notificationsList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'PendingNotificationList')), opt=True)
    _IpaEuiccData_defaultSmdpAddress = STR_UTF8(name='defaultSmdpAddress', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _IpaEuiccData_euiccPackageResultList = SEQ_OF(name='euiccPackageResultList', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EuiccPackageResultList')), opt=True)
    ...
    _IpaEuiccData_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    ...
    IpaEuiccData._cont = ASN1Dict([
        ...
        ('euiccPackageResultList', _IpaEuiccData_euiccPackageResultList),
        ...
        ('eimTransactionId', _IpaEuiccData_eimTransactionId),
    ...
    ___ProfileDownloadTriggerResult_profileDownloadTriggerResultData_profileDownloadError_profileDownloadErrorReason = INT(name='profileDownloadErrorReason', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ___ProfileDownloadTriggerResult_profileDownloadTriggerResultData_profileDownloadError_profileDownloadErrorReason._cont = ASN1Dict([('ecallActive', 104), ('undefinedError', 127)])
    ___ProfileDownloadTriggerResult_profileDownloadTriggerResultData_profileDownloadError_errorResponse = OCT_STR(name='errorResponse', mode=MODE_TYPE, opt=True)
    __ProfileDownloadTriggerResult_profileDownloadTriggerResultData_profileDownloadError._cont = ASN1Dict([
        ('profileDownloadErrorReason', ___ProfileDownloadTriggerResult_profileDownloadTriggerResultData_profileDownloadError_profileDownloadErrorReason),
    ...
    #-----< ISDRProprietaryApplicationTemplateIoT >-----#
    ISDRProprietaryApplicationTemplateIoT = SEQ(name='ISDRProprietaryApplicationTemplateIoT', mode=MODE_TYPE, tag=(1, TAG_PRIVATE, TAG_IMPLICIT))
    _ISDRProprietaryApplicationTemplateIoT_euiccConfiguration = BIT_STR(name='euiccConfiguration', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ISDRProprietaryApplicationTemplateIoT_euiccConfiguration._cont = ASN1Dict([('ipaeSupported', 0), ('enabledProfile', 1)])
    ISDRProprietaryApplicationTemplateIoT._cont = ASN1Dict([
        ('euiccConfiguration', _ISDRProprietaryApplicationTemplateIoT_euiccConfiguration),
        ])
    ISDRProprietaryApplicationTemplateIoT._ext = []
    
    #-----< IpaeActivationRequest >-----#
    IpaeActivationRequest = SEQ(name='IpaeActivationRequest', mode=MODE_TYPE, tag=(66, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _IpaeActivationRequest_ipaeOption = BIT_STR(name='ipaeOption', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _IpaeActivationRequest_ipaeOption._cont = ASN1Dict([('activateIpae', 0)])
    IpaeActivationRequest._cont = ASN1Dict([
        ('ipaeOption', _IpaeActivationRequest_ipaeOption),
        ])
    IpaeActivationRequest._ext = []
    
    #-----< IpaeActivationResponse >-----#
    IpaeActivationResponse = SEQ(name='IpaeActivationResponse', mode=MODE_TYPE, tag=(66, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _IpaeActivationResponse_ipaeActivationResult = INT(name='ipaeActivationResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _IpaeActivationResponse_ipaeActivationResult._cont = ASN1Dict([('ok', 0), ('notSupported', 1)])
    IpaeActivationResponse._cont = ASN1Dict([
        ('ipaeActivationResult', _IpaeActivationResponse_ipaeActivationResult),
        ])
    IpaeActivationResponse._ext = []
    ...
    _ProfileInfo_profilePolicyRules = BIT_STR(name='profilePolicyRules', mode=MODE_TYPE, tag=(25, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'PprIds')), opt=True)
    _ProfileInfo_serviceSpecificDataStoredInEuicc = SEQ_OF(name='serviceSpecificDataStoredInEuicc', mode=MODE_TYPE, tag=(34, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VendorSpecificExtension')), opt=True)
    _ProfileInfo_ecallIndication = BOOL(name='ecallIndication', mode=MODE_TYPE, tag=(123, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ProfileInfo_fallbackAttribute = BOOL(name='fallbackAttribute', mode=MODE_TYPE, tag=(38, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=False)
    _ProfileInfo_fallbackAllowed = BOOL(name='fallbackAllowed', mode=MODE_TYPE, tag=(103, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ProfileInfo._cont = ASN1Dict([
        ('iccid', _ProfileInfo_iccid),
        ('isdpAid', _ProfileInfo_isdpAid),
        ('profileState', _ProfileInfo_profileState),
        ...
        ('profilePolicyRules', _ProfileInfo_profilePolicyRules),
        ('serviceSpecificDataStoredInEuicc', _ProfileInfo_serviceSpecificDataStoredInEuicc),
        ('ecallIndication', _ProfileInfo_ecallIndication),
        ('fallbackAttribute', _ProfileInfo_fallbackAttribute),
        ('fallbackAllowed', _ProfileInfo_fallbackAllowed),
        ])
    ProfileInfo._ext = []
    ...
    _StoreMetadataRequest_serviceSpecificDataStoredInEuicc = SEQ_OF(name='serviceSpecificDataStoredInEuicc', mode=MODE_TYPE, tag=(34, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VendorSpecificExtension')), opt=True)
    _StoreMetadataRequest_serviceSpecificDataNotStoredInEuicc = SEQ_OF(name='serviceSpecificDataNotStoredInEuicc', mode=MODE_TYPE, tag=(35, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'VendorSpecificExtension')), opt=True)
    _StoreMetadataRequest_ecallIndication = BOOL(name='ecallIndication', mode=MODE_TYPE, tag=(123, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _StoreMetadataRequest_fallbackAllowed = BOOL(name='fallbackAllowed', mode=MODE_TYPE, tag=(103, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    StoreMetadataRequest._cont = ASN1Dict([
        ('iccid', _StoreMetadataRequest_iccid),
        ('serviceProviderName', _StoreMetadataRequest_serviceProviderName),
        ('profileName', _StoreMetadataRequest_profileName),
        ...
        ('serviceSpecificDataStoredInEuicc', _StoreMetadataRequest_serviceSpecificDataStoredInEuicc),
        ('serviceSpecificDataNotStoredInEuicc', _StoreMetadataRequest_serviceSpecificDataNotStoredInEuicc),
        ('ecallIndication', _StoreMetadataRequest_ecallIndication),
        ('fallbackAllowed', _StoreMetadataRequest_fallbackAllowed),
        ])
    StoreMetadataRequest._ext = []
    ...
    AuthenticateClientRequest = SEQ(name='AuthenticateClientRequest', mode=MODE_TYPE, tag=(59, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AuthenticateClientRequest_transactionId = OCT_STR(name='transactionId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')))
    _AuthenticateClientRequest_authenticateServerResponse = CHOICE(name='authenticateServerResponse', mode=MODE_TYPE, tag=(56, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'AuthenticateServerResponse')))
    AuthenticateClientRequest._cont = ASN1Dict([
        ('transactionId', _AuthenticateClientRequest_transactionId),
        ('authenticateServerResponse', _AuthenticateClientRequest_authenticateServerResponse),
        ])
    ...
    _IoTSpecificInfo_ecallSupported = NULL(name='ecallSupported', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _IoTSpecificInfo_fallbackSupported = NULL(name='fallbackSupported', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    IoTSpecificInfo._cont = ASN1Dict([
        ('iotVersion', _IoTSpecificInfo_iotVersion),
        ('ecallSupported', _IoTSpecificInfo_ecallSupported),
        ('fallbackSupported', _IoTSpecificInfo_fallbackSupported),
        ])
    ...
    _AddInitialEimResponse_addInitialEimError._cont = ASN1Dict([('insufficientMemory', 1), ('associatedEimAlreadyExists', 2), ('ciPKUnknown', 3), ('invalidAssociationToken', 5), ('counterValueOutOfRange', 6), ('commandError', 7), ('undefinedError', 127)])
    ...
    #-----< EuiccMemoryResetRequest >-----#
    EuiccMemoryResetRequest = SEQ(name='EuiccMemoryResetRequest', mode=MODE_TYPE, tag=(100, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccMemoryResetRequest_resetOptions = BIT_STR(name='resetOptions', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccMemoryResetRequest_resetOptions._cont = ASN1Dict([('deleteOperationalProfiles', 0), ('deleteFieldLoadedTestProfiles', 1), ('resetDefaultSmdpAddress', 2), ('deletePreLoadedTestProfiles', 3), ('deleteProvisioningProfiles', 4), ('resetEimConfigData', 5), ('resetImmediateEnableConfig', 6)])
    EuiccMemoryResetRequest._cont = ASN1Dict([
        ('resetOptions', _EuiccMemoryResetRequest_resetOptions),
        ])
    EuiccMemoryResetRequest._ext = []
    ...
    #-----< EuiccMemoryResetResponse >-----#
    EuiccMemoryResetResponse = SEQ(name='EuiccMemoryResetResponse', mode=MODE_TYPE, tag=(100, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccMemoryResetResponse_resetResult = INT(name='resetResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccMemoryResetResponse_resetResult._cont = ASN1Dict([('ok', 0), ('nothingToDelete', 1), ('catBusy', 5), ('ecallActive', 104), ('undefinedError', 127)])
    _EuiccMemoryResetResponse_resetEimResult = INT(name='resetEimResult', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _EuiccMemoryResetResponse_resetEimResult._cont = ASN1Dict([('ok', 0), ('nothingToDelete', 1), ('eimResetNotSupported', 2), ('undefinedError', 127)])
    _EuiccMemoryResetResponse_resetImmediateEnableConfigResult = INT(name='resetImmediateEnableConfigResult', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _EuiccMemoryResetResponse_resetImmediateEnableConfigResult._cont = ASN1Dict([('ok', 0), ('resetIECNotSupported', 1), ('undefinedError', 127)])
    EuiccMemoryResetResponse._cont = ASN1Dict([
        ('resetResult', _EuiccMemoryResetResponse_resetResult),
        ('resetEimResult', _EuiccMemoryResetResponse_resetEimResult),
        ('resetImmediateEnableConfigResult', _EuiccMemoryResetResponse_resetImmediateEnableConfigResult),
        ])
    EuiccMemoryResetResponse._ext = []
    ...
    __RetrieveNotificationsListRequest_searchCriteria_seqNumber = INT(name='seqNumber', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __RetrieveNotificationsListRequest_searchCriteria_profileManagementOperation = BIT_STR(name='profileManagementOperation', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'NotificationEvent')))
    __RetrieveNotificationsListRequest_searchCriteria_euiccPackageResults = NULL(name='euiccPackageResults', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _RetrieveNotificationsListRequest_searchCriteria._cont = ASN1Dict([
        ('seqNumber', __RetrieveNotificationsListRequest_searchCriteria_seqNumber),
        ('profileManagementOperation', __RetrieveNotificationsListRequest_searchCriteria_profileManagementOperation),
        ('euiccPackageResults', __RetrieveNotificationsListRequest_searchCriteria_euiccPackageResults),
        ])
    _RetrieveNotificationsListRequest_searchCriteria._ext = []
    RetrieveNotificationsListRequest._cont = ASN1Dict([
        ('searchCriteria', _RetrieveNotificationsListRequest_searchCriteria),
    ...
    #-----< RetrieveNotificationsListResponse >-----#
    RetrieveNotificationsListResponse = CHOICE(name='RetrieveNotificationsListResponse', mode=MODE_TYPE, tag=(43, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _RetrieveNotificationsListResponse_notificationList = SEQ_OF(name='notificationList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'PendingNotificationList')))
    _RetrieveNotificationsListResponse_notificationsListResultError = INT(name='notificationsListResultError', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _RetrieveNotificationsListResponse_notificationsListResultError._cont = ASN1Dict([('undefinedError', 127)])
    _RetrieveNotificationsListResponse_euiccPackageResultList = SEQ_OF(name='euiccPackageResultList', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EuiccPackageResultList')))
    RetrieveNotificationsListResponse._cont = ASN1Dict([
        ('notificationList', _RetrieveNotificationsListResponse_notificationList),
        ('notificationsListResultError', _RetrieveNotificationsListResponse_notificationsListResultError),
    ...
    #-----< ImmediateEnableRequest >-----#
    ImmediateEnableRequest = SEQ(name='ImmediateEnableRequest', mode=MODE_TYPE, tag=(90, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ImmediateEnableRequest_refreshFlag = BOOL(name='refreshFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ImmediateEnableRequest._cont = ASN1Dict([
        ('refreshFlag', _ImmediateEnableRequest_refreshFlag),
        ])
    ImmediateEnableRequest._ext = []
    
    #-----< ImmediateEnableResponse >-----#
    ImmediateEnableResponse = SEQ(name='ImmediateEnableResponse', mode=MODE_TYPE, tag=(90, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ImmediateEnableResponse_immediateEnableResult = INT(name='immediateEnableResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ImmediateEnableResponse_immediateEnableResult._cont = ASN1Dict([('ok', 0), ('immediateEnableNotAvailable', 1), ('noSessionContext', 4), ('catBusy', 5), ('undefinedError', 127)])
    ImmediateEnableResponse._cont = ASN1Dict([
        ('immediateEnableResult', _ImmediateEnableResponse_immediateEnableResult),
        ])
    ImmediateEnableResponse._ext = []
    ...
    #-----< ConfigureImmediateProfileEnablingRequest >-----#
    ConfigureImmediateProfileEnablingRequest = SEQ(name='ConfigureImmediateProfileEnablingRequest', mode=MODE_TYPE, tag=(89, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ConfigureImmediateProfileEnablingRequest_immediateEnableFlag = NULL(name='immediateEnableFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ConfigureImmediateProfileEnablingRequest_defaultSmdpOid = OID(name='defaultSmdpOid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _ConfigureImmediateProfileEnablingRequest_defaultSmdpAddress = STR_UTF8(name='defaultSmdpAddress', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ConfigureImmediateProfileEnablingRequest._cont = ASN1Dict([
        ('immediateEnableFlag', _ConfigureImmediateProfileEnablingRequest_immediateEnableFlag),
        ('defaultSmdpOid', _ConfigureImmediateProfileEnablingRequest_defaultSmdpOid),
        ('defaultSmdpAddress', _ConfigureImmediateProfileEnablingRequest_defaultSmdpAddress),
        ])
    ConfigureImmediateProfileEnablingRequest._ext = []
    
    #-----< ConfigureImmediateProfileEnablingResponse >-----#
    ConfigureImmediateProfileEnablingResponse = SEQ(name='ConfigureImmediateProfileEnablingResponse', mode=MODE_TYPE, tag=(89, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ConfigureImmediateProfileEnablingResponse_configImmediateEnableResult = INT(name='configImmediateEnableResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ConfigureImmediateProfileEnablingResponse_configImmediateEnableResult._cont = ASN1Dict([('ok', 0), ('insufficientMemory', 1), ('associatedEimAlreadyExists', 2), ('undefinedError', 127)])
    ConfigureImmediateProfileEnablingResponse._cont = ASN1Dict([
        ('configImmediateEnableResult', _ConfigureImmediateProfileEnablingResponse_configImmediateEnableResult),
        ])
    ConfigureImmediateProfileEnablingResponse._ext = []
    ...
    _GetEimConfigurationDataRequest_searchCriteria = CHOICE(name='searchCriteria', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT), opt=True)
    __GetEimConfigurationDataRequest_searchCriteria_eimId = STR_UTF8(name='eimId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __GetEimConfigurationDataRequest_searchCriteria_eimId._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=128)], ev=None, er=[])
    _GetEimConfigurationDataRequest_searchCriteria._cont = ASN1Dict([
        ('eimId', __GetEimConfigurationDataRequest_searchCriteria_eimId),
        ])
    _GetEimConfigurationDataRequest_searchCriteria._ext = []
    GetEimConfigurationDataRequest._cont = ASN1Dict([
        ('searchCriteria', _GetEimConfigurationDataRequest_searchCriteria),
        ])
    ...
    #-----< ExecuteFallbackMechanismRequest >-----#
    ExecuteFallbackMechanismRequest = SEQ(name='ExecuteFallbackMechanismRequest', mode=MODE_TYPE, tag=(93, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ExecuteFallbackMechanismRequest_refreshFlag = BOOL(name='refreshFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ExecuteFallbackMechanismRequest._cont = ASN1Dict([
        ('refreshFlag', _ExecuteFallbackMechanismRequest_refreshFlag),
        ])
    ExecuteFallbackMechanismRequest._ext = []
    
    #-----< ExecuteFallbackMechanismResponse >-----#
    ExecuteFallbackMechanismResponse = SEQ(name='ExecuteFallbackMechanismResponse', mode=MODE_TYPE, tag=(93, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ExecuteFallbackMechanismResponse_executeFallbackMechanismResult = INT(name='executeFallbackMechanismResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ExecuteFallbackMechanismResponse_executeFallbackMechanismResult._cont = ASN1Dict([('ok', 0), ('profileNotInDisabledState', 2), ('catBusy', 5), ('fallbackNotAvailable', 6), ('commandError', 7), ('ecallActive', 104), ('undefinedError', 127)])
    ExecuteFallbackMechanismResponse._cont = ASN1Dict([
        ('executeFallbackMechanismResult', _ExecuteFallbackMechanismResponse_executeFallbackMechanismResult),
        ])
    ExecuteFallbackMechanismResponse._ext = []
    
    #-----< ReturnFromFallbackRequest >-----#
    ReturnFromFallbackRequest = SEQ(name='ReturnFromFallbackRequest', mode=MODE_TYPE, tag=(94, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ReturnFromFallbackRequest_refreshFlag = BOOL(name='refreshFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ReturnFromFallbackRequest._cont = ASN1Dict([
        ('refreshFlag', _ReturnFromFallbackRequest_refreshFlag),
        ])
    ReturnFromFallbackRequest._ext = []
    
    #-----< ReturnFromFallbackResponse >-----#
    ReturnFromFallbackResponse = SEQ(name='ReturnFromFallbackResponse', mode=MODE_TYPE, tag=(94, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ReturnFromFallbackResponse_returnFromFallbackResult = INT(name='returnFromFallbackResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ReturnFromFallbackResponse_returnFromFallbackResult._cont = ASN1Dict([('ok', 0), ('catBusy', 5), ('fallbackNotAvailable', 6), ('commandError', 7), ('undefinedError', 127)])
    ReturnFromFallbackResponse._cont = ASN1Dict([
        ('returnFromFallbackResult', _ReturnFromFallbackResponse_returnFromFallbackResult),
        ])
    ReturnFromFallbackResponse._ext = []
    
    #-----< EnableEmergencyProfileRequest >-----#
    EnableEmergencyProfileRequest = SEQ(name='EnableEmergencyProfileRequest', mode=MODE_TYPE, tag=(91, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EnableEmergencyProfileRequest_refreshFlag = BOOL(name='refreshFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    EnableEmergencyProfileRequest._cont = ASN1Dict([
        ('refreshFlag', _EnableEmergencyProfileRequest_refreshFlag),
        ])
    EnableEmergencyProfileRequest._ext = []
    
    #-----< EnableEmergencyProfileResponse >-----#
    EnableEmergencyProfileResponse = SEQ(name='EnableEmergencyProfileResponse', mode=MODE_TYPE, tag=(91, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EnableEmergencyProfileResponse_enableEmergencyProfileResult = INT(name='enableEmergencyProfileResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EnableEmergencyProfileResponse_enableEmergencyProfileResult._cont = ASN1Dict([('ok', 0), ('profileNotInDisabledState', 2), ('catBusy', 5), ('ecallNotAvailable', 8), ('undefinedError', 127)])
    EnableEmergencyProfileResponse._cont = ASN1Dict([
        ('enableEmergencyProfileResult', _EnableEmergencyProfileResponse_enableEmergencyProfileResult),
        ])
    EnableEmergencyProfileResponse._ext = []
    
    #-----< DisableEmergencyProfileRequest >-----#
    DisableEmergencyProfileRequest = SEQ(name='DisableEmergencyProfileRequest', mode=MODE_TYPE, tag=(92, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _DisableEmergencyProfileRequest_refreshFlag = BOOL(name='refreshFlag', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    DisableEmergencyProfileRequest._cont = ASN1Dict([
        ('refreshFlag', _DisableEmergencyProfileRequest_refreshFlag),
        ])
    DisableEmergencyProfileRequest._ext = []
    
    #-----< DisableEmergencyProfileResponse >-----#
    DisableEmergencyProfileResponse = SEQ(name='DisableEmergencyProfileResponse', mode=MODE_TYPE, tag=(92, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _DisableEmergencyProfileResponse_disableEmergencyProfileResult = INT(name='disableEmergencyProfileResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _DisableEmergencyProfileResponse_disableEmergencyProfileResult._cont = ASN1Dict([('ok', 0), ('profileNotInEnabledState', 2), ('catBusy', 5), ('undefinedError', 127)])
    DisableEmergencyProfileResponse._cont = ASN1Dict([
        ('disableEmergencyProfileResult', _DisableEmergencyProfileResponse_disableEmergencyProfileResult),
        ])
    DisableEmergencyProfileResponse._ext = []
    
    #-----< GetConnectivityParametersRequest >-----#
    GetConnectivityParametersRequest = SEQ(name='GetConnectivityParametersRequest', mode=MODE_TYPE, tag=(95, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    GetConnectivityParametersRequest._cont = ASN1Dict([
        ])
    GetConnectivityParametersRequest._ext = []
    
    #-----< GetConnectivityParametersResponse >-----#
    GetConnectivityParametersResponse = CHOICE(name='GetConnectivityParametersResponse', mode=MODE_TYPE, tag=(95, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _GetConnectivityParametersResponse_connectivityParameters = SEQ(name='connectivityParameters', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ConnectivityParameters')))
    _GetConnectivityParametersResponse_connectivityParametersError = INT(name='connectivityParametersError', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ConnectivityParametersError')))
    GetConnectivityParametersResponse._cont = ASN1Dict([
        ('connectivityParameters', _GetConnectivityParametersResponse_connectivityParameters),
        ('connectivityParametersError', _GetConnectivityParametersResponse_connectivityParametersError),
        ])
    GetConnectivityParametersResponse._ext = []
    
    #-----< ConnectivityParameters >-----#
    ConnectivityParameters = SEQ(name='ConnectivityParameters', mode=MODE_TYPE)
    _ConnectivityParameters_httpParams = OCT_STR(name='httpParams', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ConnectivityParameters._cont = ASN1Dict([
        ('httpParams', _ConnectivityParameters_httpParams),
        ])
    ConnectivityParameters._ext = []
    
    #-----< ConnectivityParametersError >-----#
    ConnectivityParametersError = INT(name='ConnectivityParametersError', mode=MODE_TYPE)
    ConnectivityParametersError._cont = ASN1Dict([('parametersNotAvailable', 1), ('undefinedError', 127)])
    
    #-----< SetDefaultDpAddressRequest >-----#
    SetDefaultDpAddressRequest = SEQ(name='SetDefaultDpAddressRequest', mode=MODE_TYPE, tag=(101, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _SetDefaultDpAddressRequest_defaultDpAddress = STR_UTF8(name='defaultDpAddress', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    SetDefaultDpAddressRequest._cont = ASN1Dict([
        ('defaultDpAddress', _SetDefaultDpAddressRequest_defaultDpAddress),
        ])
    ...
    #-----< SetDefaultDpAddressResponse >-----#
    SetDefaultDpAddressResponse = SEQ(name='SetDefaultDpAddressResponse', mode=MODE_TYPE, tag=(101, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _SetDefaultDpAddressResponse_setDefaultDpAddressResult = INT(name='setDefaultDpAddressResult', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _SetDefaultDpAddressResponse_setDefaultDpAddressResult._cont = ASN1Dict([('ok', 0), ('undefinedError', 127)])
    SetDefaultDpAddressResponse._cont = ASN1Dict([
        ('setDefaultDpAddressResult', _SetDefaultDpAddressResponse_setDefaultDpAddressResult),
    ...
    _EuiccSigned1_serverAddress = STR_UTF8(name='serverAddress', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _EuiccSigned1_serverChallenge = OCT_STR(name='serverChallenge', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet16')))
    _EuiccSigned1_euiccInfo2 = SEQ(name='euiccInfo2', mode=MODE_TYPE, tag=(34, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EUICCInfo2')))
    _EuiccSigned1_ctxParams1 = CHOICE(name='ctxParams1', mode=MODE_TYPE, typeref=ASN1RefType(('RSPDefinitions', 'CtxParams1')))
    EuiccSigned1._cont = ASN1Dict([
        ('transactionId', _EuiccSigned1_transactionId),
        ('serverAddress', _EuiccSigned1_serverAddress),
    ...
    #-----< AuthenticateResponseOk >-----#
    AuthenticateResponseOk = SEQ(name='AuthenticateResponseOk', mode=MODE_TYPE)
    _AuthenticateResponseOk_euiccSigned1 = SEQ(name='euiccSigned1', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'EuiccSigned1')))
    _AuthenticateResponseOk_euiccSignature1 = OCT_STR(name='euiccSignature1', mode=MODE_TYPE, tag=(55, TAG_APPLICATION, TAG_IMPLICIT))
    _AuthenticateResponseOk_euiccCertificate = SEQ(name='euiccCertificate', mode=MODE_TYPE, typeref=ASN1RefType(('PKIX1Explicit88', 'Certificate')))
    _AuthenticateResponseOk_eumCertificate = SEQ(name='eumCertificate', mode=MODE_TYPE, typeref=ASN1RefType(('PKIX1Explicit88', 'Certificate')))
    AuthenticateResponseOk._cont = ASN1Dict([
    ...
    #-----< AuthenticateServerResponse >-----#
    AuthenticateServerResponse = CHOICE(name='AuthenticateServerResponse', mode=MODE_TYPE, tag=(56, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AuthenticateServerResponse_authenticateResponseOk = SEQ(name='authenticateResponseOk', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'AuthenticateResponseOk')))
    _AuthenticateServerResponse_authenticateResponseError = SEQ(name='authenticateResponseError', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'AuthenticateResponseError')))
    ...
    __CompactAuthenticateResponseOk_signedData_euiccSigned1 = SEQ(name='euiccSigned1', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'EuiccSigned1')))
    ...
    _CompactOtherSignedNotification_eidValue = OCT_STR(name='eidValue', mode=MODE_TYPE, tag=(26, TAG_APPLICATION, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet16')), opt=True)
    ...
    CompactOtherSignedNotification._cont = ASN1Dict([
        ('eidValue', _CompactOtherSignedNotification_eidValue),
    ...
    _EsipaMessageFromIpaToEim_provideEimPackageResult = SEQ(name='provideEimPackageResult', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ProvideEimPackageResult')))
    ...
    _EsipaMessageFromEimToIpa_provideEimPackageResultResponse = CHOICE(name='provideEimPackageResultResponse', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ProvideEimPackageResultResponse')))
    ...
    _InitiateAuthenticationRequestEsipa_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    InitiateAuthenticationRequestEsipa._cont = ASN1Dict([
        ...
        ('eimTransactionId', _InitiateAuthenticationRequestEsipa_eimTransactionId),
        ])
    ...
    _InitiateAuthenticationResponseEsipa_initiateAuthenticationErrorEsipa._cont = ASN1Dict([('invalidDpAddress', 1), ('euiccVersionNotSupportedByDp', 2), ('ciPKIdNotSupported', 3), ('smdpAddressMismatch', 50), ('smdpOidMismatch', 51), ('invalidEimTransactionId', 52), ('undefinedError', 127)])
    ...
    _InitiateAuthenticationOkEsipa_euiccCiPKIdentifierToBeUsed = OCT_STR(name='euiccCiPKIdentifierToBeUsed', mode=MODE_TYPE)
    ...
    InitiateAuthenticationOkEsipa._cont = ASN1Dict([
        ...
        ('euiccCiPKIdentifierToBeUsed', _InitiateAuthenticationOkEsipa_euiccCiPKIdentifierToBeUsed),
    ...
    _AuthenticateClientOkDPEsipa_profileMetaData = SEQ(name='profileMetaData', mode=MODE_TYPE, tag=(37, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'StoreMetadataRequest')), opt=True)
    ...
    _HandleNotificationEsipa_pendingNotification = CHOICE(name='pendingNotification', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'PendingNotification')))
    _HandleNotificationEsipa_provideEimPackageResult = SEQ(name='provideEimPackageResult', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ProvideEimPackageResult')))
    ...
    #-----< StateChangeCause >-----#
    StateChangeCause = INT(name='StateChangeCause', mode=MODE_TYPE)
    StateChangeCause._cont = ASN1Dict([('otherEim', 0), ('fallback', 1), ('emergencyProfile', 2), ('local', 3), ('reset', 4), ('immediateEnableProfile', 5), ('deviceChange', 6), ('undefined', 127)])
    ...
    _GetEimPackageRequest_stateChangeCause = INT(name='stateChangeCause', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'StateChangeCause')), opt=True)
    _GetEimPackageRequest_rPLMN = OCT_STR(name='rPLMN', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ...
    GetEimPackageRequest._cont = ASN1Dict([
        ...
        ('stateChangeCause', _GetEimPackageRequest_stateChangeCause),
    ...
    _GetEimPackageResponse_eimPackageError._cont = ASN1Dict([('noEimPackageAvailable', 1), ('eidNotFound', 2), ('invalidEid', 3), ('missingEid', 4), ('undefinedError', 127)])
    ...
    #-----< EimPackageResultErrorCode >-----#
    EimPackageResultErrorCode = INT(name='EimPackageResultErrorCode', mode=MODE_TYPE)
    EimPackageResultErrorCode._cont = ASN1Dict([('invalidPackageFormat', 1), ('unknownPackage', 2), ('undefinedError', 127)])
    
    #-----< EimPackageResultResponseError >-----#
    EimPackageResultResponseError = SEQ(name='EimPackageResultResponseError', mode=MODE_TYPE)
    _EimPackageResultResponseError_eimTransactionId = OCT_STR(name='eimTransactionId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'TransactionId')), opt=True)
    _EimPackageResultResponseError_eimPackageResultErrorCode = INT(name='eimPackageResultErrorCode', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'EimPackageResultErrorCode')))
    EimPackageResultResponseError._cont = ASN1Dict([
        ('eimTransactionId', _EimPackageResultResponseError_eimTransactionId),
        ('eimPackageResultErrorCode', _EimPackageResultResponseError_eimPackageResultErrorCode),
        ])
    EimPackageResultResponseError._ext = []
    
    #-----< EimPackageResult >-----#
    EimPackageResult = CHOICE(name='EimPackageResult', mode=MODE_TYPE)
    _EimPackageResult_euiccPackageResult = CHOICE(name='euiccPackageResult', mode=MODE_TYPE, tag=(81, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EuiccPackageResult')))
    _EimPackageResult_ePRAndNotifications = SEQ(name='ePRAndNotifications', mode=MODE_TYPE)
    __EimPackageResult_ePRAndNotifications_euiccPackageResult = CHOICE(name='euiccPackageResult', mode=MODE_TYPE, tag=(81, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EuiccPackageResult')))
    __EimPackageResult_ePRAndNotifications_notificationList = SEQ_OF(name='notificationList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'PendingNotificationList')))
    _EimPackageResult_ePRAndNotifications._cont = ASN1Dict([
        ('euiccPackageResult', __EimPackageResult_ePRAndNotifications_euiccPackageResult),
        ('notificationList', __EimPackageResult_ePRAndNotifications_notificationList),
        ])
    _EimPackageResult_ePRAndNotifications._ext = []
    _EimPackageResult_ipaEuiccDataResponse = CHOICE(name='ipaEuiccDataResponse', mode=MODE_TYPE, tag=(82, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'IpaEuiccDataResponse')))
    _EimPackageResult_profileDownloadTriggerResult = SEQ(name='profileDownloadTriggerResult', mode=MODE_TYPE, tag=(84, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'ProfileDownloadTriggerResult')))
    _EimPackageResult_eimPackageResultResponseError = SEQ(name='eimPackageResultResponseError', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EimPackageResultResponseError')))
    EimPackageResult._cont = ASN1Dict([
        ('euiccPackageResult', _EimPackageResult_euiccPackageResult),
        ('ePRAndNotifications', _EimPackageResult_ePRAndNotifications),
        ('ipaEuiccDataResponse', _EimPackageResult_ipaEuiccDataResponse),
        ('profileDownloadTriggerResult', _EimPackageResult_profileDownloadTriggerResult),
        ('eimPackageResultResponseError', _EimPackageResult_eimPackageResultResponseError),
        ])
    EimPackageResult._ext = []
    
    #-----< ProvideEimPackageResult >-----#
    ProvideEimPackageResult = SEQ(name='ProvideEimPackageResult', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ProvideEimPackageResult_eidValue = OCT_STR(name='eidValue', mode=MODE_TYPE, tag=(26, TAG_APPLICATION, TAG_IMPLICIT), typeref=ASN1RefType(('RSPDefinitions', 'Octet16')), opt=True)
    _ProvideEimPackageResult_eimPackageResult = CHOICE(name='eimPackageResult', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'EimPackageResult')))
    ProvideEimPackageResult._cont = ASN1Dict([
        ('eidValue', _ProvideEimPackageResult_eidValue),
        ('eimPackageResult', _ProvideEimPackageResult_eimPackageResult),
        ])
    ProvideEimPackageResult._ext = []
    
    #-----< ProvideEimPackageResultResponse >-----#
    ProvideEimPackageResultResponse = CHOICE(name='ProvideEimPackageResultResponse', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ProvideEimPackageResultResponse_eimAcknowledgements = SEQ_OF(name='eimAcknowledgements', mode=MODE_TYPE, tag=(83, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'EimAcknowledgements')))
    _ProvideEimPackageResultResponse_emptyResponse = SEQ(name='emptyResponse', mode=MODE_TYPE)
    _ProvideEimPackageResultResponse_emptyResponse._cont = ASN1Dict([
        ])
    _ProvideEimPackageResultResponse_emptyResponse._ext = []
    _ProvideEimPackageResultResponse_provideEimPackageResultError = INT(name='provideEimPackageResultError', mode=MODE_TYPE)
    _ProvideEimPackageResultResponse_provideEimPackageResultError._cont = ASN1Dict([('eidNotFound', 2), ('invalidEid', 3), ('missingEid', 4), ('undefinedError', 127)])
    ProvideEimPackageResultResponse._cont = ASN1Dict([
        ('eimAcknowledgements', _ProvideEimPackageResultResponse_eimAcknowledgements),
        ('emptyResponse', _ProvideEimPackageResultResponse_emptyResponse),
        ('provideEimPackageResultError', _ProvideEimPackageResultResponse_provideEimPackageResultError),
        ])
    ...
    __TransferEimPackageResponse_ePRAndNotifications_notificationList = SEQ_OF(name='notificationList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('SGP32Definitions', 'PendingNotificationList')))
    ...
    _all_ = [
        ...
        _EuiccPackageSigned_eimTransactionId,
        ...
        _EimConfigurationData_indirectProfileDownload,
        EimConfigurationData,
        EimIdType,
        EimSupportedProtocol,
        _Eco_addEim,
        ...
        _Psmo_getRAT,
        __Psmo_configureImmediateEnable_immediateEnableFlag,
        __Psmo_configureImmediateEnable_defaultSmdpOid,
        __Psmo_configureImmediateEnable_defaultSmdpAddress,
        _Psmo_configureImmediateEnable,
        __Psmo_setFallbackAttribute_iccid,
        _Psmo_setFallbackAttribute,
        _Psmo_unsetFallbackAttribute,
        _Psmo_setDefaultDpAddress,
        Psmo,
        _IpaEuiccDataRequest_tagList,
        _IpaEuiccDataRequest_euiccCiPKIdentifierToBeUsed,
        __IpaEuiccDataRequest_searchCriteriaNotification_seqNumber,
        __IpaEuiccDataRequest_searchCriteriaNotification_profileManagementOperation,
        _IpaEuiccDataRequest_searchCriteriaNotification,
        __IpaEuiccDataRequest_searchCriteriaEuiccPackageResult_seqNumber,
        _IpaEuiccDataRequest_searchCriteriaEuiccPackageResult,
        _IpaEuiccDataRequest_eimTransactionId,
        IpaEuiccDataRequest,
        ...
        _EuiccPackageResultDataSigned_eimTransactionId,
        ...
        _EuiccResultData_configureImmediateEnableResult,
        ...
        _EuiccResultData_setFallbackAttributeResult,
        _EuiccResultData_unsetFallbackAttributeResult,
        _EuiccResultData_processingTerminated,
        _EuiccResultData_setDefaultDpAddressResult,
        EuiccResultData,
        ...
        _EuiccPackageErrorDataSigned_eimTransactionId,
        _EuiccPackageErrorDataSigned_euiccPackageErrorCode,
        EuiccPackageErrorDataSigned,
        EuiccPackageErrorCode,
        _EuiccPackageErrorUnsigned_eimId,
        _EuiccPackageErrorUnsigned_eimTransactionId,
        ...
        EimIdInfo,
        IpaEuiccDataErrorCode,
        _IpaEuiccDataResponseError_eimTransactionId,
        _IpaEuiccDataResponseError_ipaEuiccDataErrorCode,
        IpaEuiccDataResponseError,
        _IpaEuiccDataResponse_ipaEuiccData,
        _IpaEuiccDataResponse_ipaEuiccDataResponseError,
        IpaEuiccDataResponse,
        _PendingNotificationList__item_,
        PendingNotificationList,
        _EuiccPackageResultList__item_,
        EuiccPackageResultList,
        _IpaEuiccData_notificationsList,
        _IpaEuiccData_defaultSmdpAddress,
        _IpaEuiccData_euiccPackageResultList,
        ...
        _IpaEuiccData_eimTransactionId,
        ...
        ___ProfileDownloadTriggerResult_profileDownloadTriggerResultData_profileDownloadError_profileDownloadErrorReason,
        ...
        ProfileDownloadTriggerResult,
        _ISDRProprietaryApplicationTemplateIoT_euiccConfiguration,
        ISDRProprietaryApplicationTemplateIoT,
        _IpaeActivationRequest_ipaeOption,
        IpaeActivationRequest,
        _IpaeActivationResponse_ipaeActivationResult,
        IpaeActivationResponse,
        ...
        _ProfileInfo_profilePolicyRules,
        _ProfileInfo_serviceSpecificDataStoredInEuicc,
        _ProfileInfo_ecallIndication,
        _ProfileInfo_fallbackAttribute,
        _ProfileInfo_fallbackAllowed,
        ProfileInfo,
        _StoreMetadataRequest_iccid,
        _StoreMetadataRequest_serviceProviderName,
        _StoreMetadataRequest_profileName,
        ...
        _StoreMetadataRequest_serviceSpecificDataStoredInEuicc,
        _StoreMetadataRequest_serviceSpecificDataNotStoredInEuicc,
        _StoreMetadataRequest_ecallIndication,
        _StoreMetadataRequest_fallbackAllowed,
        StoreMetadataRequest,
        _AuthenticateClientRequest_transactionId,
        _AuthenticateClientRequest_authenticateServerResponse,
        AuthenticateClientRequest,
        ...
        _IoTSpecificInfo_ecallSupported,
        _IoTSpecificInfo_fallbackSupported,
        IoTSpecificInfo,
        IpaMode,
        ...
        EuiccMemoryResetRequest,
        _EuiccMemoryResetResponse_resetResult,
        _EuiccMemoryResetResponse_resetEimResult,
        _EuiccMemoryResetResponse_resetImmediateEnableConfigResult,
        EuiccMemoryResetResponse,
        ...
        __RetrieveNotificationsListRequest_searchCriteria_seqNumber,
        __RetrieveNotificationsListRequest_searchCriteria_profileManagementOperation,
        __RetrieveNotificationsListRequest_searchCriteria_euiccPackageResults,
        _RetrieveNotificationsListRequest_searchCriteria,
        RetrieveNotificationsListRequest,
        _RetrieveNotificationsListResponse_notificationList,
        _RetrieveNotificationsListResponse_notificationsListResultError,
        ...
        RetrieveNotificationsListResponse,
        _ImmediateEnableRequest_refreshFlag,
        ImmediateEnableRequest,
        _ImmediateEnableResponse_immediateEnableResult,
        ImmediateEnableResponse,
        ...
        ProfileRollbackResponse,
        _ConfigureImmediateProfileEnablingRequest_immediateEnableFlag,
        _ConfigureImmediateProfileEnablingRequest_defaultSmdpOid,
        _ConfigureImmediateProfileEnablingRequest_defaultSmdpAddress,
        ConfigureImmediateProfileEnablingRequest,
        _ConfigureImmediateProfileEnablingResponse_configImmediateEnableResult,
        ConfigureImmediateProfileEnablingResponse,
        __GetEimConfigurationDataRequest_searchCriteria_eimId,
        _GetEimConfigurationDataRequest_searchCriteria,
        GetEimConfigurationDataRequest,
        ...
        GetEimConfigurationDataResponse,
        _ExecuteFallbackMechanismRequest_refreshFlag,
        ExecuteFallbackMechanismRequest,
        _ExecuteFallbackMechanismResponse_executeFallbackMechanismResult,
        ExecuteFallbackMechanismResponse,
        _ReturnFromFallbackRequest_refreshFlag,
        ReturnFromFallbackRequest,
        _ReturnFromFallbackResponse_returnFromFallbackResult,
        ReturnFromFallbackResponse,
        _EnableEmergencyProfileRequest_refreshFlag,
        EnableEmergencyProfileRequest,
        _EnableEmergencyProfileResponse_enableEmergencyProfileResult,
        EnableEmergencyProfileResponse,
        _DisableEmergencyProfileRequest_refreshFlag,
        DisableEmergencyProfileRequest,
        _DisableEmergencyProfileResponse_disableEmergencyProfileResult,
        DisableEmergencyProfileResponse,
        GetConnectivityParametersRequest,
        _GetConnectivityParametersResponse_connectivityParameters,
        _GetConnectivityParametersResponse_connectivityParametersError,
        GetConnectivityParametersResponse,
        _ConnectivityParameters_httpParams,
        ConnectivityParameters,
        ConnectivityParametersError,
        _SetDefaultDpAddressRequest_defaultDpAddress,
        SetDefaultDpAddressRequest,
        ...
        CompactSuccessResult,
        _CompactOtherSignedNotification_eidValue,
        ...
        _InitiateAuthenticationRequestEsipa_eimTransactionId,
        InitiateAuthenticationRequestEsipa,
        ...
        _InitiateAuthenticationOkEsipa_euiccCiPKIdentifierToBeUsed,
        ...
        _GetEimPackageRequest_stateChangeCause,
        ...
        GetEimPackageResponse,
        EimPackageResultErrorCode,
        _EimPackageResultResponseError_eimTransactionId,
        _EimPackageResultResponseError_eimPackageResultErrorCode,
        EimPackageResultResponseError,
        _EimPackageResult_euiccPackageResult,
        __EimPackageResult_ePRAndNotifications_euiccPackageResult,
        __EimPackageResult_ePRAndNotifications_notificationList,
        _EimPackageResult_ePRAndNotifications,
        _EimPackageResult_ipaEuiccDataResponse,
        _EimPackageResult_profileDownloadTriggerResult,
        _EimPackageResult_eimPackageResultResponseError,
        EimPackageResult,
        _ProvideEimPackageResult_eidValue,
        _ProvideEimPackageResult_eimPackageResult,
        ProvideEimPackageResult,
        _ProvideEimPackageResultResponse_eimAcknowledgements,
        _ProvideEimPackageResultResponse_emptyResponse,
        _ProvideEimPackageResultResponse_provideEimPackageResultError,
        ProvideEimPackageResultResponse,
