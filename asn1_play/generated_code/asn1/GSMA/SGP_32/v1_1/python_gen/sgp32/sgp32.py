...
class SGP32Definitions:
    ...
    _EimPackageResult_eimPackageResultErrorCode = INT(name='eimPackageResultErrorCode', mode=MODE_TYPE, typeref=ASN1RefType(('SGP32Definitions', 'EimPackageResultErrorCode')))
    ...
    EimPackageResult._cont = ASN1Dict([
        ...
        ('eimPackageResultErrorCode', _EimPackageResult_eimPackageResultErrorCode),
    ...
    _all_ = [
        ...
        _EimPackageResult_eimPackageResultErrorCode,
