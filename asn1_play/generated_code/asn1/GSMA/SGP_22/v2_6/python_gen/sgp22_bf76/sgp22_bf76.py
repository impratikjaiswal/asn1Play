...
class RSPDefinitions:
    ...
    _obj_ = [
        ...
        'id-rsp-metadata',
        'id-rsp-metadata-serviceSpecificOIDs',
        'id-rsp-metadata-activationCodeRetrievalInfo',
        'id-rsp-cert-objects',
        'id-rspExt',
        'id-rspRole',
        'id-rspRole-ci',
    ...
    _DeviceAdditionalFeatureSupport_groupOfDeviceManufacturerOid = OID(name='groupOfDeviceManufacturerOid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    DeviceAdditionalFeatureSupport._cont = ASN1Dict([
        ('naiSupport', _DeviceAdditionalFeatureSupport_naiSupport),
        ('groupOfDeviceManufacturerOid', _DeviceAdditionalFeatureSupport_groupOfDeviceManufacturerOid),
        ])
    ...
    #-----< ActivationCodeRetrievalInfo >-----#
    ActivationCodeRetrievalInfo = CHOICE(name='ActivationCodeRetrievalInfo', mode=MODE_TYPE)
    _ActivationCodeRetrievalInfo_activationCodeForProfileRedownload = STR_UTF8(name='activationCodeForProfileRedownload', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ActivationCodeRetrievalInfo_activationCodeForProfileRedownload._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[])
    _ActivationCodeRetrievalInfo_activationCodeRetrievalAvailable = BOOL(name='activationCodeRetrievalAvailable', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _ActivationCodeRetrievalInfo_retryDelay = INT(name='retryDelay', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ActivationCodeRetrievalInfo._cont = ASN1Dict([
        ('activationCodeForProfileRedownload', _ActivationCodeRetrievalInfo_activationCodeForProfileRedownload),
        ('activationCodeRetrievalAvailable', _ActivationCodeRetrievalInfo_activationCodeRetrievalAvailable),
        ('retryDelay', _ActivationCodeRetrievalInfo_retryDelay),
        ])
    ActivationCodeRetrievalInfo._ext = []
    
    #-----< id-rsp-metadata >-----#
    id_rsp_metadata = OID(name='id-rsp-metadata', mode=MODE_VALUE)
    id_rsp_metadata._val = (2, 23, 146, 1, 3)
    
    #-----< id-rsp-metadata-serviceSpecificOIDs >-----#
    id_rsp_metadata_serviceSpecificOIDs = OID(name='id-rsp-metadata-serviceSpecificOIDs', mode=MODE_VALUE)
    id_rsp_metadata_serviceSpecificOIDs._val = (2, 23, 146, 1, 3, 1)
    
    #-----< id-rsp-metadata-activationCodeRetrievalInfo >-----#
    id_rsp_metadata_activationCodeRetrievalInfo = OID(name='id-rsp-metadata-activationCodeRetrievalInfo', mode=MODE_VALUE)
    id_rsp_metadata_activationCodeRetrievalInfo._val = (2, 23, 146, 1, 3, 1, 1)
    ...
    _AuthenticateClientRequest_useMatchingIdForAcr = NULL(name='useMatchingIdForAcr', mode=MODE_TYPE, opt=True)
    AuthenticateClientRequest._cont = ASN1Dict([
        ...
        ('useMatchingIdForAcr', _AuthenticateClientRequest_useMatchingIdForAcr),
        ])
    ...
    _GetBoundProfilePackageResponse_getBoundProfilePackageError._cont = ASN1Dict([('euiccSignatureInvalid', 1), ('confirmationCodeMissing', 2), ('confirmationCodeRefused', 3), ('confirmationCodeRetriesExceeded', 4), ('bppRebindingRefused', 5), ('deprecated', 6), ('invalidTransactionId', 95), ('undefinedError', 127)])
    ...
    _all_ = [
        ...
        _DeviceAdditionalFeatureSupport_groupOfDeviceManufacturerOid,
        DeviceAdditionalFeatureSupport,
        CatSupportedClasses,
        EuiccFormFactorType,
        ...
        SetNicknameResponse,
        _ActivationCodeRetrievalInfo_activationCodeForProfileRedownload,
        _ActivationCodeRetrievalInfo_activationCodeRetrievalAvailable,
        _ActivationCodeRetrievalInfo_retryDelay,
        ActivationCodeRetrievalInfo,
        id_rsp_metadata,
        id_rsp_metadata_serviceSpecificOIDs,
        id_rsp_metadata_activationCodeRetrievalInfo,
        id_rsp_cert_objects,
        id_rspExt,
        id_rspRole,
        id_rspRole_ci,
        ...
        _AuthenticateClientRequest_useMatchingIdForAcr,
        AuthenticateClientRequest,
