...
class PEDefinitions:
    ...
    _PE_OPT_IoT_df_df_saip = SEQ_OF(name='df-df-saip', mode=MODE_TYPE, tag=(25, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_IoT_ef_suci_calc_info_usim = SEQ_OF(name='ef-suci-calc-info-usim', mode=MODE_TYPE, tag=(26, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
