...
class PEDefinitions:
    ...
    _ServicesList_tuak = NULL(name='tuak', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ...
    _Fcp_fileDescriptor._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=5)], ev=None, er=[])
    ...
    _Fcp_shortEFID._const_sz = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    ...
    _PE_OPT_USIM_ef_aeem = SEQ_OF(name='ef-aeem', mode=MODE_TYPE, tag=(36, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    ...
    _PE_OPT_USIM_ef_gbabp = SEQ_OF(name='ef-gbabp', mode=MODE_TYPE, tag=(54, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_msk = SEQ_OF(name='ef-msk', mode=MODE_TYPE, tag=(55, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_muk = SEQ_OF(name='ef-muk', mode=MODE_TYPE, tag=(56, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ehplmn = SEQ_OF(name='ef-ehplmn', mode=MODE_TYPE, tag=(57, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_gbanl = SEQ_OF(name='ef-gbanl', mode=MODE_TYPE, tag=(58, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ehplmnpi = SEQ_OF(name='ef-ehplmnpi', mode=MODE_TYPE, tag=(59, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_lrplmnsi = SEQ_OF(name='ef-lrplmnsi', mode=MODE_TYPE, tag=(60, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_nafkca = SEQ_OF(name='ef-nafkca', mode=MODE_TYPE, tag=(61, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_spni = SEQ_OF(name='ef-spni', mode=MODE_TYPE, tag=(62, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ppni = SEQ_OF(name='ef-ppni', mode=MODE_TYPE, tag=(63, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ncp_ip = SEQ_OF(name='ef-ncp-ip', mode=MODE_TYPE, tag=(64, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ufc = SEQ_OF(name='ef-ufc', mode=MODE_TYPE, tag=(65, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_nasconfig = SEQ_OF(name='ef-nasconfig', mode=MODE_TYPE, tag=(66, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_uicciari = SEQ_OF(name='ef-uicciari', mode=MODE_TYPE, tag=(67, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_pws = SEQ_OF(name='ef-pws', mode=MODE_TYPE, tag=(68, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_fdnuri = SEQ_OF(name='ef-fdnuri', mode=MODE_TYPE, tag=(69, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_bdnuri = SEQ_OF(name='ef-bdnuri', mode=MODE_TYPE, tag=(70, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_sdnuri = SEQ_OF(name='ef-sdnuri', mode=MODE_TYPE, tag=(71, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_iwl = SEQ_OF(name='ef-iwl', mode=MODE_TYPE, tag=(72, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ips = SEQ_OF(name='ef-ips', mode=MODE_TYPE, tag=(73, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    _PE_OPT_USIM_ef_ipd = SEQ_OF(name='ef-ipd', mode=MODE_TYPE, tag=(74, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    ...
    _PE_OPT_ISIM_ef_psismsc = SEQ_OF(name='ef-psismsc', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    PE_OPT_ISIM._cont = ASN1Dict([
        ...
        ('ef-psismsc', _PE_OPT_ISIM_ef_psismsc),
        ])
    PE_OPT_ISIM._ext = []
    ...
    _PE_OPT_CSIM_ef_sf_eumid = SEQ_OF(name='ef-sf-eumid', mode=MODE_TYPE, tag=(44, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'File')), opt=True)
    ...
    PE_OPT_CSIM._cont = ASN1Dict([
        ...
        ('ef-sf-eumid', _PE_OPT_CSIM_ef_sf_eumid),
    ...
    _AlgoParameter_key = OCT_STR(name='key', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AlgoParameter_opc = OCT_STR(name='opc', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AlgoParameter_rotationConstants = OCT_STR(name='rotationConstants', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=b'@\x00 @`')
    _AlgoParameter_rotationConstants._const_sz = ASN1Set(rv=[5], rr=[], ev=None, er=[])
    _AlgoParameter_xoringConstants = OCT_STR(name='xoringConstants', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x08')
    _AlgoParameter_xoringConstants._const_sz = ASN1Set(rv=[40], rr=[], ev=None, er=[])
    _AlgoParameter_sqnInit = SEQ_OF(name='sqnInit', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=[b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00', b'\x00\x00\x00\x00\x00\x00'])
    __AlgoParameter_sqnInit__item_ = OCT_STR(name='_item_', mode=MODE_TYPE)
    __AlgoParameter_sqnInit__item_._const_sz = ASN1Set(rv=[6], rr=[], ev=None, er=[])
    _AlgoParameter_sqnInit._cont = __AlgoParameter_sqnInit__item_
    _AlgoParameter_sqnInit._const_sz = ASN1Set(rv=[32], rr=[], ev=None, er=[])
    AlgoParameter._cont = ASN1Dict([
        ...
        ('sqnInit', _AlgoParameter_sqnInit),
        ])
    AlgoParameter._ext = []
    ...
    _PE_AKAParameter_algorithmID = INT(name='algorithmID', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _PE_AKAParameter_algorithmID._cont = ASN1Dict([('milenage', 1), ('tuak', 2)])
    _PE_AKAParameter_algorithmOptions = OCT_STR(name='algorithmOptions', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _PE_AKAParameter_algorithmOptions._const_sz = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    _PE_AKAParameter_lgoConfiguration = CHOICE(name='lgoConfiguration', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT))
    __PE_AKAParameter_lgoConfiguration_mappingParameter = SEQ(name='mappingParameter', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'MappingParameter')))
    __PE_AKAParameter_lgoConfiguration_algoParameter = SEQ(name='algoParameter', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'AlgoParameter')))
    _PE_AKAParameter_lgoConfiguration._cont = ASN1Dict([
        ('mappingParameter', __PE_AKAParameter_lgoConfiguration_mappingParameter),
        ('algoParameter', __PE_AKAParameter_lgoConfiguration_algoParameter),
        ])
    _PE_AKAParameter_lgoConfiguration._ext = []
    _PE_AKAParameter_sqnOptions = OCT_STR(name='sqnOptions', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=b'\x02')
    _PE_AKAParameter_sqnOptions._const_sz = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    _PE_AKAParameter_sqnDelta = OCT_STR(name='sqnDelta', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=b'\x00\x00\x10\x00\x00\x00')
    _PE_AKAParameter_sqnDelta._const_sz = ASN1Set(rv=[6], rr=[], ev=None, er=[])
    _PE_AKAParameter_sqnAgeLimit = OCT_STR(name='sqnAgeLimit', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=b'\x00\x00\x10\x00\x00\x00')
    _PE_AKAParameter_sqnAgeLimit._const_sz = ASN1Set(rv=[6], rr=[], ev=None, er=[])
    _PE_AKAParameter_authCounterMax = OCT_STR(name='authCounterMax', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _PE_AKAParameter_authCounterMax._const_sz = ASN1Set(rv=[3], rr=[], ev=None, er=[])
    PE_AKAParameter._cont = ASN1Dict([
        ('aka-header', _PE_AKAParameter_aka_header),
        ('algorithmID', _PE_AKAParameter_algorithmID),
        ('algorithmOptions', _PE_AKAParameter_algorithmOptions),
        ('lgoConfiguration', _PE_AKAParameter_lgoConfiguration),
        ('sqnOptions', _PE_AKAParameter_sqnOptions),
        ('sqnDelta', _PE_AKAParameter_sqnDelta),
        ('sqnAgeLimit', _PE_AKAParameter_sqnAgeLimit),
        ('authCounterMax', _PE_AKAParameter_authCounterMax),
        ])
    ...
    _PE_CDMAParameter_hrpdAccessAuthenticationData._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=8, ub=255)], ev=None, er=[])
    ...
    _PE_CDMAParameter_simpleIPAuthenticationData._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=10, ub=4112)], ev=None, er=[])
    ...
    _PE_CDMAParameter_mobileIPAuthenticationData._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=19, ub=8208)], ev=None, er=[])
    ...
    _KeyObject_keyUsageQualifier._const_sz = ASN1Set(rv=[1], rr=[], ev=None, er=[])
    _KeyObject_keyAccess = OCT_STR(name='keyAccess', mode=MODE_TYPE, tag=(22, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ...
    _KeyObject_keyCheckValue = OCT_STR(name='keyCheckValue', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _KeyObject_keyCounterValue = OCT_STR(name='keyCounterValue', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _KeyObject_scp80SeqCounter = OCT_STR(name='scp80SeqCounter', mode=MODE_TYPE, opt=True)
    ...
    KeyObject._cont = ASN1Dict([
        ...
        ('keyCheckValue', _KeyObject_keyCheckValue),
        ('keyCounterValue', _KeyObject_keyCounterValue),
        ('scp80SeqCounter', _KeyObject_scp80SeqCounter),
    ...
    _ApplicationInstance_lifeCycleState = OCT_STR(name='lifeCycleState', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), default=b'\x03')
    ...
    _UICCApplicationParameters_uiccAccessApplicationSpecificParametersField = OCT_STR(name='uiccAccessApplicationSpecificParametersField', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    _UICCApplicationParameters_uiccAccessParams = OCT_STR(name='uiccAccessParams', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True)
    ...
    UICCApplicationParameters._cont = ASN1Dict([
        ...
        ('uiccAccessParams', _UICCApplicationParameters_uiccAccessParams),
    ...
    _PE_RFM_rfm_header = SEQ(name='rfm-header', mode=MODE_TYPE, typeref=ASN1RefType(('PEDefinitions', 'PEHeader')))
    _PE_RFM_securityDomainAID = OCT_STR(name='securityDomainAID', mode=MODE_TYPE, tag=(15, TAG_APPLICATION, TAG_IMPLICIT), typeref=ASN1RefType(('PEDefinitions', 'ApplicationIdentifier')))
    _PE_RFM_tarList = SEQ_OF(name='tarList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ...
    _PEStatus_status._cont = ASN1Dict([('ok', 0), ('pe-not-supported', 1), ('memory-failure', 2), ('bad-values', 3), ('not-enough-memory', 4), ('invalid-request-format', 5), ('invalid-parameter', 6), ('runtime-not-supported', 7), ('lib-not-supported', 8), ('template-not-supported', 9), ('feature-not-supported', 10), ('unsupported-profile-version', 31)])
    ...
    _all_ = [
        ...
        __AlgoParameter_sqnInit__item_,
        _AlgoParameter_sqnInit,
        AlgoParameter,
        _PE_AKAParameter_aka_header,
        _PE_AKAParameter_algorithmID,
        _PE_AKAParameter_algorithmOptions,
        __PE_AKAParameter_lgoConfiguration_mappingParameter,
        __PE_AKAParameter_lgoConfiguration_algoParameter,
        _PE_AKAParameter_lgoConfiguration,
        _PE_AKAParameter_sqnOptions,
        _PE_AKAParameter_sqnDelta,
        _PE_AKAParameter_sqnAgeLimit,
        _PE_AKAParameter_authCounterMax,
        PE_AKAParameter,
        ...
        _KeyObject_keyCheckValue,
        _KeyObject_keyCounterValue,
        _KeyObject_scp80SeqCounter,
        ...
        _UICCApplicationParameters_uiccAccessParams,
