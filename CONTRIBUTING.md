...
If you've noticed a bug, [please submit an issue](https://github.com/impratikjaiswal/asn1Play/issues/new).

## Bug Reports Guidelines

1. **Use the GitHub issue search.** Check if the issue has already been
   [reported](https://github.com/impratikjaiswal/asn1Play/issues).
...
If this is something you think you can fix, then [fork](https://github.com/impratikjaiswal/asn1Play/fork) and create
